...
// @author 江小白
// @version 963540817.801
// @include /^https?:\/\/(?:(?:v(?:-wb)?|m)\.youku\.com\/.+?\/id_|vku\.youku\.com\/live\/|[^\/]+?\.tudou\.com\/(?:v\/|.+?\/id_)|v\.qq\.com\/(?:x\/(?:cover|page)|variety\/p\/topic)\/|(?:3g|m)\.v\.qq\.com|w(?:ww)?\.mgtv\.com\/[a-z]\/|www\.mgtv\.com\/act\/|m\.mgtv\.com\/b\/|www\.iqiyi\.com\/(?:[avw]_|kszt\/)|m\.iqiyi\.com\/v_|tw\.iqiyi\.com\/v_|tv\.sohu\.com\/v\/|m\.tv\.sohu\.com\/(?:u\/|v|phone_play_film\?aid=)|film\.sohu\.com\/album\/|www\.le\.com\/ptv\/vplay\/|m\.le\.com\/vplay_|[vm]\.pptv\.com\/show\/|vip\.1905\.com\/play\/|www\.wasu\.cn\/(?:Play|wap\/.+?)\/show\/id\/|(?:player|live)\.bilibili\.com\/|www\.bilibili\.com\/(?:(?:cheese|bangumi)\/play|blackboard|.*?video)\/|m\.bilibili\.com\/bangumi\/play\/|www\.fun\.tv\/vplay\/g-|www\.ixigua\.com\/\d{10,}|(?:m\.)?music\.migu\.cn\/|kg\.qq\.com\/node\/|movie\.douban\.com\/subject\/|m\.douban\.com\/movie\/subject\/|www\.acfun\.cn\/(?:.+?\/ac|bangumi\/)|m\.acfun\.cn\/v\/|live\.acfun\.cn\/live\/|[^\/]*?cupfox\.|www\.bumimi.+?\/search\/|www\.jiaomh\.com\/(?:kmahua\/|search\.php\?searchword=)|www\.yinyuetai\.com\/play\?id=|(?:y\.)?music\.163\.com\/|(?:(?:bd|www)\.)?kuwo\.cn\/|m\.kuwo\.cn\/newh5|www\.kugou\.com\/(?:song|mvweb)\/|m3ws\.kugou\.com\/(?:kgsong|mv)\/|m\.kugou\.com\/|(?:i\.)?y\.qq\.com\/|(?:www|h|m)\.xiami\.com\/|5sing\.kugou\.com\/|(?:www|m)\.ximalaya\.com\/|www\.app-echo\.com\/|radio\.sky31\.com\/|www\.1ting\.com\/|(?:www|m)\.9ku\.com\/play\/|www\.lrts\.me\/playlist|miao101\.com\/(?:search|video)|www\.douyin\.com\/video\/|www\.kuaishou\.com\/|www\.555dy6\.com\/(?:vodsearch|vodplay)\/|haokan\.(?:baidu|hao123)\.com\/v|tieba\.baidu\.com\/p\/|z1\.m1907\.cn\/|pgso\.cnjsjf\.com\/\?|(?:www\.wbdy\.tv|www\.ikukk\.com)\/|[^\/]+?\/(?:tv|acg|mov)\/|.+?(?:&autoplay=1&metareferer=|(?:\w+?_\w+?|search|jx|url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?](?:https?:\/\/[^\/]+?\.(?:youku|mgtv|sohu|pptv|wasu|1905|iqiyi|le|qq|bilibili|acfun|fun|ixigua)\.|\d+?&type=(?:ximalaya|1ting))))/
// @grant GM_setValue
// @grant GM_getValue
// @noframes
// @run-at document-end
			...
			if (window.location.href.match(/\.163\..+?\/store/)) {} else {
				try {
					if (!document.querySelector("\u6c5f\u5c0f\u767d")) {
						...
						try {
							if (document.location.protocol.indexOf("http") != -1 && (document.referrer.indexOf(
									location.href.split("/")[2]) == -1 || document.referrer.indexOf(location
									.href.split("/")[2]) > 10)) {
					...
					function jxbvipobj() {
						var arra = [],
							arrb = [],
							arrahttpsjk, arrbhttpsjk, httpsjk, vipzdjx, vipjxtb, vipjxss, vipjxkjj, gbdmobj,
							gbkjjjobj, jstgggobj, pdssgjcobj, mgzdgq, lkzdzt, zdbfqp, zdwbfobj, sjtzjx,
							jxbzdjxdsqobj, jishu;
						const obj = window.location.href,
							objj = window.location.host,
							objjj = window.location.search,
							log = console.log;
						const ttblwobj = obj.match(
							/^https?:\/\/(?:w(?:ww)?\.mgtv\.com\/(?!b)[a-z]\/|(?:player|live)\.bilibili\.com|www\.bilibili\.com\/(?:cheese\/play|.*?video|blackboard)\/|www\.acfun\.cn\/player\/ac)/
							);
						const pcliwaiobj = obj.match(
							/^https?:\/\/(?:v(?:-wb)?\.youku\.com\/v_show\/id_|[^\/]+?\.tudou\.com\/(?:v\/|.+?\/id_)|v\.qq\.com\/(?:x\/cover|variety\/p\/topic)\/|w(?:ww)?\.mgtv\.com\/(?:b|act)\/|www\.iqiyi\.com\/(?:[awv]_|kszt\/)|tw\.iqiyi\.com\/v_|tv\.sohu\.com\/v\/|film\.sohu\.com\/album\/|www\.le\.com\/ptv\/vplay\/|v\.pptv\.com\/show\/|vip\.1905\.com\/play\/|www\.wasu\.cn\/.+?\/show\/id\/|www\.bilibili\.com\/bangumi\/play\/|www\.acfun\.cn\/bangumi\/|www\.fun\.tv\/vplay\/g-|www\.ixigua\.com\/\d{10,})/
							);
						const sjliwaiobj = obj.match(
							/^https?:\/\/(?:m\.youku\.com\/.+?\/id_|m\.mgtv\.com\/b\/|m\.pptv\.com\/show\/|vip\.1905\.com\/play\/|m\.tv\.sohu\.com\/(?:v|phone_play_film\?aid=)|m\.le\.com\/vplay_|m\.iqiyi\.com\/v_|www\.wasu\.cn\/.+?\/show\/id\/|(?:3g|m)\.v\.qq\.com\/.*?(?:[cv]id=|cover\/)|m\.bilibili\.com\/bangumi\/play\/|m\.acfun\.cn\/v\/)/
							);
						const iqiyialiwaiobj = obj.match(/^https?:\/\/(?:www|m)\.iqiyi\.com\/(?:a_|kszt\/)/) &&
							document.title.match(new RegExp("在线观看")),
							iqiyibliwaiobj = obj.match(/^https?:\/\/(?:www|m)\.iqiyi\.com\/v_/) && document.title
							.match(new RegExp("名师课堂")),
							iqiyicliwaiobj = obj.match(/^https?:\/\/m\.iqiyi\.com\/v_/) && document.title.match(
								new RegExp("[部季集话部期>》)）:：].*?(?:预告|片花|花絮|彩蛋|看点)"));
						const jxjkobj = obj.match(
							/^https?:\/\/.+?(?:\.m(?:3u8|p4)\?\w+?=|(?:\w+?_\w+?|search|jx|url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?:\/\/[^\/]+?\.(?:youku|mgtv|sohu|pptv|wasu|1905|iqiyi|le|qq|bilibili|acfun|fun|ixigua)\.)/
							);
						const kjjlwobj = !ttblwobj;
						const vipzdjxwzobj = (pcliwaiobj || sjliwaiobj) && !iqiyialiwaiobj && !iqiyibliwaiobj;
						const ttbkjjliobj = objj.match(
							/(?:music\.163|kuwo|kugou|(?:y|kg)\.qq|xiami|migu|ximalaya|eggvod|app-echo)/);
						const jxbpcobj = !
							/(?:phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i
							.test(window.navigator.userAgent);
						const jxbpclwobj = /(?:Firefox|Opera)/i.test(navigator.userAgent);
						const mmkjjtjobj = obj.match(
							/^https?:\/\/(?:v\.qq\.com\/x\/page\/|www\.yinyuetai\.com\/play\?id=)/);
									...
									(function() {
										...
										let zdbfdsq = setInterval(function() {
											function zdqpobj() {
												...
												if (obj.match(
														/^https?:\/\/www\.acfun\.cn\/player\/ac/)) {
													document.querySelector(
														"#ACPlayer>div>div.container-video>div>div.container-controls>div.control-bar-top>div.box-right>div.fullscreen.fullscreen-screen>div"
														).click()
												} else if (obj.match(
														/^https?:\/\/player\.bilibili\.com\/player\.html\?aid=/
														)) {
													document.querySelector('i[data-text="进入全屏"]')
														.click()
												} else {}
											};
											...
											let zdbfbobj = document.getElementsByTagName("video")[
											0];
											if (zdbfaobj) {
												...
												log("%c江小白--01-H5视频自动播放",
													"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
													);
										...
										(function(window, undefined) {
											var readyList, rootjQuery, core_strundefined = typeof undefined,
												...
												completed = function(event) {
													if (document.addEventListener || event.type ===
											...
											jQuery.fn = jQuery.prototype = {
												...
												init: function(selector, context, rootjQuery) {
													...
													if (typeof selector === "string") {
														if (selector.charAt(0) === "<" && selector
															.charAt(selector.length - 1) === ">" &&
															selector.length >= 3) {
												...
												get: function(num) {
													return num == null ? this.toArray() : (num < 0 ?
														this[this.length + num] : this[num])
												},
												...
												eq: function(i) {
													var len = this.length,
														j = +i + (i < 0 ? len : 0);
													return this.pushStack(j >= 0 && j < len ? [this[
														j]] : [])
												},
											...
											jQuery.extend({
												...
												isNumeric: function(obj) {
													return !isNaN(parseFloat(obj)) && isFinite(
														obj)
												},
												type: function(obj) {
													if (obj == null) {
													...
													return typeof obj === "object" ||
														typeof obj === "function" ? class2type[
												...
												isPlainObject: function(obj) {
													...
													try {
														if (obj.constructor && !core_hasOwn
													...
													for (key in obj) {}
													return key === undefined || core_hasOwn
														.call(obj, key)
												},
												...
												trim: core_trim && !core_trim.call("\uFEFF\xA0") ?
													function(text) {
														return text == null ? "" : core_trim.call(
															text)
													} : function(text) {
												...
												proxy: function(fn, context) {
													...
													proxy = function() {
														return fn.apply(context || this,
															args.concat(core_slice.call(
																arguments)))
													};
													proxy.guid = fn.guid = fn.guid || jQuery
														.guid++;
													return proxy
												},
												access: function(elems, fn, key, value, chainable,
													...
													return chainable ? elems : bulk ? fn.call(
															elems) : length ? fn(elems[0],
														key) : emptyGet
												},
												now: function() {
											...
											(function(window, undefined) {
												var i, support, cachedruns, Expr, getText, isXML,
													compile, outermostContext, sortInput, setDocument,
													document, docElem, documentIsHTML, rbuggyQSA,
													rbuggyMatches, matches, contains, expando =
													"sizzle" + -(new Date()),
													...
													escapedWhitespace) {
														...
														return high !== high || escapedWhitespace ?
															escaped : high < 0 ? String.fromCharCode(
																high + 0x10000) : String.fromCharCode(
																high >> 10 | 0xD800, high & 0x3FF |
																0xDC00)
													};
												try {
													push.apply((arr = slice.call(preferredDoc
														.childNodes)), preferredDoc.childNodes);
												...
												function Sizzle(selector, context, results, seed) {
													var match, elem, m, nodeType, i, groups, old, nid,
														newContext, newSelector;
													...
													if (documentIsHTML && !seed) {
														...
														if (support.qsa && (!rbuggyQSA || !rbuggyQSA
																.test(selector))) {
															nid = old = expando;
															newContext = context;
															newSelector = nodeType === 9 && selector;
															if (nodeType === 1 && context.nodeName
																.toLowerCase() !== "object") {
																groups = tokenize(selector);
																if ((old = context.getAttribute(
																	"id"))) {
												...
												function siblingCheck(a, b) {
													var cur = b && a,
														diff = cur && a.nodeType === 1 && b.nodeType ===
														1 && (~b.sourceIndex || MAX_NEGATIVE) - (~a
												...
												isXML = Sizzle.isXML = function(elem) {
													var documentElement = elem && (elem
														.ownerDocument || elem).documentElement;
												...
												setDocument = Sizzle.setDocument = function(node) {
													...
													support.getElementsByClassName = assert(
														function(div) {
															...
															return div.getElementsByClassName(
																"i").length === 2
														});
													support.getById = assert(function(div) {
														docElem.appendChild(div).id =
															expando;
														return !doc.getElementsByName || !
															doc.getElementsByName(expando)
															.length
													});
													if (support.getById) {
													...
													rbuggyMatches = [];
													rbuggyQSA = [];
													if ((support.qsa = rnative.test(doc
															.querySelectorAll))) {
														assert(function(div) {
															div.innerHTML =
													...
													contains = rnative.test(docElem.contains) ||
														docElem.compareDocumentPosition ? function(
															a, b) {
															var adown = a.nodeType === 9 ? a
																.documentElement : a,
																bup = b && b.parentNode;
															return a === bup || !!(bup && bup
																.nodeType === 1 && (adown
																	.contains ? adown.contains(
																		bup) : a
													...
													sortOrder = docElem.compareDocumentPosition ?
														function(a, b) {
															...
															if (a === b) {
																...
																return a === doc ? -1 : b === doc ?
																	1 : aup ? -1 : bup ? 1 :
																	sortInput ? (indexOf.call(
																			sortInput, a) - indexOf
																		.call(sortInput, b)) : 0
															} else if (aup === bup) {
												...
												Sizzle.matchesSelector = function(elem, expr) {
													...
													if (support.matchesSelector && documentIsHTML &&
														(!rbuggyMatches || !rbuggyMatches.test(
															expr)) && (!rbuggyQSA || !rbuggyQSA
															.test(expr))) {
														try {
															var ret = matches.call(elem, expr);
															if (ret || support.disconnectedMatch ||
																elem.document && elem.document
																.nodeType !== 11) {
																return ret
															}
														} catch (e) {}
												...
												Sizzle.attr = function(elem, name) {
													...
													var fn = Expr.attrHandle[name.toLowerCase()],
														val = fn && hasOwn.call(Expr.attrHandle,
															name.toLowerCase()) ? fn(elem, name, !
															documentIsHTML) : undefined;
													return val === undefined ? support.attributes ||
														!documentIsHTML ? elem.getAttribute(name) :
														(val = elem.getAttributeNode(name)) && val
														.specified ? val.value : null : val
												};
												...
												Sizzle.uniqueSort = function(results) {
													...
													sortInput = !support.sortStable && results
														.slice(0);
												...
												Expr = Sizzle.selectors = {
													...
													preFilter: {
														...
														"CHILD": function(match) {
															...
															if (match[1].slice(0, 3) ===
																"nth") {
																if (!match[3]) {
																	Sizzle.error(match[0])
																}
																match[4] = +(match[4] ? match[
																	5] + (match[6] || 1) :
																	2 * (match[3] ===
																		"even" || match[
																		3] === "odd"));
																match[5] = +((match[7] + match[
																		8]) || match[3] ===
																	"odd")
															} else if (match[3]) {
																Sizzle.error(match[0])
													...
													filter: {
														...
														"CHILD": function(type, what, argument,
															first, last) {
															var simple = type.slice(0, 3) !==
																"nth",
																forward = type.slice(-4) !==
																"last",
																ofType = what === "of-type";
														...
														"PSEUDO": function(pseudo, argument) {
															var args, fn = Expr.pseudos[
																pseudo] || Expr.setFilters[
																	pseudo.toLowerCase()] ||
																Sizzle.error(
																	"unsupported pseudo: " +
																	pseudo);
													...
													pseudos: {
														...
														"target": function(elem) {
															var hash = window.location && window
																.location.hash;
												...
												function tokenize(selector, parseOnly) {
													...
													return parseOnly ? soFar.length : soFar ? Sizzle
														.error(selector) : tokenCache(selector, groups)
														.slice(0)
												}
												...
												function addCombinator(matcher, combinator, base) {
													...
													return combinator.first ? function(elem, context,
														...
														var data, cache, outerCache, dirkey =
															dirruns + " " + doneName;
														if (xml) {
															while ((elem = elem[dir])) {
																if (elem.nodeType === 1 ||
													...
													return markFunction(function(seed, results, context,
														...
														var temp, i, elem, preMap = [],
															...
															matcherIn = preFilter && (seed || !
																selector) ? condense(elems,
																preMap, preFilter, context, xml
																) : elems,
														...
														if (seed) {
															...
															matcherOut = condense(matcherOut ===
																results ? matcherOut.splice(
																	preexisting, matcherOut
																	.length) : matcherOut);
															if (postFinder) {
												...
												function matcherFromTokens(tokens) {
													var checkContext, matcher, j, len = tokens.length,
														...
														implicitRelative = leadingRelative || Expr
														.relative[" "],
														...
														matchers = [function(elem, context, xml) {
															return (!leadingRelative && (xml ||
																context !== outermostContext
																)) || ((checkContext = context)
																.nodeType ? matchContext(elem,
																	context, xml) :
														...
														if ((matcher = Expr.relative[tokens[i].type])) {
															...
															if (matcher[expando]) {
																...
																return setMatcher(i > 1 &&
																	elementMatcher(matchers), i >
																	1 && toSelector(tokens.slice(0,
																		i - 1).concat({
																		value: tokens[i - 2]
																			.type === " " ?
																			"*" : ""
																	...
																	matcher, i < j &&
																	matcherFromTokens(tokens.slice(
																		i, j)), j < len &&
														...
														superMatcher = function(seed, context, xml,
															...
															var elem, j, matcher, setMatched = [],
																...
																elems = seed || byElement && Expr.find[
																	"TAG"]("*", expandContext && context
																	.parentNode || context),
																dirrunsUnique = (dirruns +=
																	contextBackup == null ? 1 : Math
																	.random() || 0.1);
															if (outermost) {
												...
												function select(selector, context, results, seed) {
													var i, tokens, token, type, find, match = tokenize(
														selector);
													if (!seed) {
														if (match.length === 1) {
															tokens = match[0] = match[0].slice(0);
															if (tokens.length > 2 && (token = tokens[0])
																.type === "ID" && support.getById &&
																context.nodeType === 9 &&
																documentIsHTML && Expr.relative[tokens[
																	1].type]) {
																context = (Expr.find["ID"](token
																	.matches[0].replace(
																		runescape, funescape),
																	context) || [])[0];
																if (!context) {
															...
															i = matchExpr["needsContext"].test(
																selector) ? 0 : tokens.length;
															while (i--) {
																token = tokens[i];
																if (Expr.relative[(type = token
																	.type)]) {
																	break
																}
													...
													compile(selector, match)(seed, context, !
														documentIsHTML, results, rsibling.test(
															selector));
													return results
												}
												...
												if (!assert(function(div) {
														...
														return div.firstChild.getAttribute(
															"href") === "#"
													})) {
												...
												if (!assert(function(div) {
													...
													addHandle(booleans, function(elem, name, isXML) {
														var val;
														if (!isXML) {
															return (val = elem.getAttributeNode(
																	name)) && val.specified ?
																val.value : elem[name] ===
											...
											function createOptions(options) {
												...
												jQuery.each(options.match(core_rnotwhite) || [], function(_,
													flag) {
													object[flag] = true
												});
												return object
											...
											jQuery.Callbacks = function(options) {
												options = typeof options === "string" ? (optionsCache[
													...
													.extend({}, options);
												var firing, memory, fired, firingLength, firingIndex,
													firingStart, list = [],
													stack = !options.once && [],
													fire = function(data) {
														...
														for (; list && firingIndex <
															...
															if (list[firingIndex].apply(data[0], data[
																	1]) === false && options
																.stopOnFalse) {
																memory = false;
																break
											...
											jQuery.extend({
												...
												when: function(subordinate) {
													var i = 0,
														...
														updateFunc = function(i, contexts,
															values) {
														...
														progressValues, progressContexts,
														resolveContexts;
													if (length > 1) {
														...
														for (; i < length; i++) {
															if (resolveValues[i] && jQuery
																.isFunction(resolveValues[i]
																	.promise)) {
											...
											jQuery.support = (function(support) {
												var all, a, input, select, fragment, opt, eventName,
													isSupported, i, div = document.createElement(
														"div");
												...
												support.leadingWhitespace = div.firstChild
													.nodeType === 3;
												support.tbody = !div.getElementsByTagName("tbody")
													.length;
												support.htmlSerialize = !!div.getElementsByTagName(
													"link").length;
												...
												support.enctype = !!document.createElement("form")
													.enctype;
												...
												support.clearCloneStyle = div.style
												...
												jQuery(function() {
													...
													body.appendChild(container).appendChild(
														div);
													div.innerHTML =
													...
													jQuery.swap(body, body.style.zoom !=
														null ? {
															zoom: 1
														} : {},
														function() {
															support.boxSizing = div
																.offsetWidth === 4
														});
													if (window.getComputedStyle) {
														support.pixelPosition = (window
															.getComputedStyle(div,
															null) || {}).top !== "1%";
														support.boxSizingReliable = (window
															.getComputedStyle(div,
															null) || {
																width: "4px"
															}).width === "4px";
														marginDiv = div.appendChild(document
															.createElement("div"));
														marginDiv.style.cssText = div.style
															.cssText = divReset;
											...
											function internalRemoveData(elem, name, pvt) {
												...
												if (name) {
													...
													if (thisCache) {
														if (!jQuery.isArray(name)) {
															...
															name = name.concat(jQuery.map(name, jQuery
																.camelCase))
														}
														i = name.length;
														while (i--) {
												...
												} else if (jQuery.support.deleteExpando || cache != cache
													.window) {
													delete cache[id]
												} else {
													cache[id] = null
											...
											jQuery.extend({
												...
												hasData: function(elem) {
													elem = elem.nodeType ? jQuery.cache[elem[
														jQuery.expando]] : elem[jQuery
														.expando];
												...
												acceptData: function(elem) {
													...
													return !noData || noData !== true && elem
												...
												data: function(key, value) {
													...
													if (key === undefined) {
														if (this.length) {
															...
															if (elem.nodeType === 1 && !jQuery
																._data(elem, "parsedAttrs")) {
													...
													if (typeof data === "string") {
														try {
															data = data === "true" ? true : data ===
																"false" ? false : data === "null" ? null : +
																data + "" === data ? +data : rbrace.test(
											...
											function isEmptyDataObject(obj) {
												var name;
												for (name in obj) {
													if (name === "data" && jQuery.isEmptyObject(obj[
														name])) {
														continue
													}
													if (name !== "toJSON") {
											...
											jQuery.extend({
												...
												_queueHooks: function(elem, type) {
													...
													return jQuery._data(elem, key) || jQuery
														._data(elem, key, {
											...
											jQuery.fn.extend({
												attr: function(name, value) {
													return jQuery.access(this, jQuery.attr,
												...
												prop: function(name, value) {
													return jQuery.access(this, jQuery.prop,
														name, value, arguments.length > 1)
												},
											...
											jQuery.extend({
												valHooks: {
													...
													select: {
														get: function(elem) {
															var value, option, options = elem
																.options,
																index = elem.selectedIndex,
																one = elem.type ===
																"select-one" || index < 0,
																values = one ? null : [],
																max = one ? index + 1 : options
																.length,
																i = index < 0 ? max : one ?
																index : 0;
															for (; i < max; i++) {
													...
													if (attrNames && elem.nodeType === 1) {
														while ((name = attrNames[i++])) {
															propName = jQuery.propFix[name] ||
																name;
															if (jQuery.expr.match.bool.test(
																	name)) {
																if (getSetInput &&
																	getSetAttribute || !
												...
												prop: function(elem, name, value) {
													var ret, hooks, notxml, nType = elem
														.nodeType;
													if (!elem || nType === 3 || nType === 8 ||
														nType === 2) {
														return
													...
													tabIndex: {
														get: function(elem) {
															var tabindex = jQuery.find.attr(
																elem, "tabindex");
															return tabindex ? parseInt(tabindex,
																	10) : rfocusable.test(elem
																	.nodeName) || rclickable
																.test(elem.nodeName) && elem
																.href ? 0 : -1
														}
													}
												}
											...
											boolHook = {
												set: function(elem, value, name) {
													if (value === false) {
														...
														ruseDefault.test(name)) {
														elem.setAttribute(!getSetAttribute && jQuery
															.propFix[name] || name, name)
													} else {
											...
											jQuery.each(jQuery.expr.match.bool.source.match(/\w+/g),
												function(i, name) {
													var getter = jQuery.expr.attrHandle[name] || jQuery
														.find.attr;
													jQuery.expr.attrHandle[name] = getSetInput &&
														getSetAttribute || !ruseDefault.test(name) ?
														function(elem, name, isXML) {
															var fn = jQuery.expr.attrHandle[name],
																ret = isXML ? undefined : (jQuery.expr
																	.attrHandle[name] = undefined) !=
																getter(elem, name, isXML) ? name
																.toLowerCase() : null;
															jQuery.expr.attrHandle[name] = fn;
															return ret
														} : function(elem, name, isXML) {
															return isXML ? undefined : elem[jQuery
											...
											if (!getSetAttribute) {
												nodeHook = {
													set: function(elem, value, name) {
														...
														if (!ret) {
															elem.setAttributeNode((ret = elem
																.ownerDocument
																.createAttribute(name)))
														}
														ret.value = value += "";
														return name === "value" || value === elem
															.getAttribute(name) ? value : undefined
													}
												};
												jQuery.expr.attrHandle.id = jQuery.expr.attrHandle.name =
													jQuery.expr.attrHandle.coords = function(elem, name,
														isXML) {
														var ret;
														return isXML ? undefined : (ret = elem
																.getAttributeNode(name)) && ret.value !==
															"" ? ret.value : null
													};
												jQuery.valHooks.button = {
													get: function(elem, name) {
														var ret = elem.getAttributeNode(name);
														return ret && ret.specified ? ret.value :
															undefined
													},
													set: nodeHook.set
												};
											...
											jQuery.event = {
												...
												add: function(elem, types, handler, data, selector) {
													var tmp, events, t, handleObjIn, special,
														eventHandle, handleObj, handlers, type,
														namespaces, origType, elemData = jQuery
														._data(elem);
													if (!elemData) {
														return
													}
													...
													if (!(eventHandle = elemData.handle)) {
														...
														e) {
															return typeof jQuery !==
																core_strundefined && (!e ||
																	jQuery.event.triggered !== e
																	.type) ? jQuery.event
																.dispatch.apply(eventHandle
																	.elem, arguments) :
																undefined
														};
													...
													while (t--) {
														...
														if (special.add) {
															...
															if (!handleObj.handler.guid) {
																handleObj.handler.guid = handler
																	.guid
															}
														}
														if (selector) {
															handlers.splice(handlers
																.delegateCount++, 0, handleObj)
														} else {
												...
												remove: function(elem, types, handler, selector,
													mappedTypes) {
													var j, handleObj, tmp, origCount, t, events,
														special, handlers, type, namespaces,
														origType, elemData = jQuery.hasData(elem) &&
														jQuery._data(elem);
													...
													while (t--) {
														...
														if (origCount && !handlers.length) {
															if (!special.teardown || special
																.teardown.call(elem, namespaces,
												...
												trigger: function(event, data, elem, onlyHandlers) {
													var handle, ontype, cur, bubbleType, special,
														tmp, i, eventPath = [elem || document],
														type = core_hasOwn.call(event, "type") ?
														event.type : event,
													...
													if (rfocusMorph.test(type + jQuery.event
															.triggered)) {
														return
													}
													if (type.indexOf(".") >= 0) {
													...
													special = jQuery.event.special[type] || {};
													if (!onlyHandlers && special.trigger && special
														.trigger.apply(elem, data) === false) {
														return
													}
													if (!onlyHandlers && !special.noBubble && !
														...
														if (tmp === (elem.ownerDocument ||
															document)) {
															eventPath.push(tmp.defaultView || tmp
																.parentWindow || window)
														}
													}
													i = 0;
													while ((cur = eventPath[i++]) && !event
														.isPropagationStopped()) {
														event.type = i > 1 ? bubbleType : special
															.bindType || type;
														...
														if (handle && jQuery.acceptData(cur) &&
															handle.apply && handle.apply(cur,
															data) === false) {
															event.preventDefault()
														}
													}
													event.type = type;
													if (!onlyHandlers && !event
													.isDefaultPrevented()) {
														if ((!special._default || special._default
																.apply(eventPath.pop(), data) ===
																false) && jQuery.acceptData(elem)) {
															if (ontype && elem[type] && !jQuery
																.isWindow(elem)) {
																tmp = elem[ontype];
																if (tmp) {
																	elem[ontype] = null
												...
												dispatch: function(event) {
													...
													if (special.preDispatch && special.preDispatch
														.call(this, event) === false) {
														return
													}
													handlerQueue = jQuery.event.handlers.call(this,
														event, handlers);
													i = 0;
													while ((matched = handlerQueue[i++]) && !event
														.isPropagationStopped()) {
														event.currentTarget = matched.elem;
														j = 0;
														while ((handleObj = matched.handlers[
															j++]) && !event
															.isImmediatePropagationStopped()) {
															if (!event.namespace_re || event
																.namespace_re.test(handleObj
																	.namespace)) {
												...
												handlers: function(event, handlers) {
													var sel, handleObj, matches, i,
														...
														cur = event.target;
													if (delegateCount && cur.nodeType && (!event
															.button || event.type !== "click")) {
														for (; cur != this; cur = cur.parentNode ||
															this) {
															if (cur.nodeType === 1 && (cur
																	.disabled !== true || event
																	.type !== "click")) {
																matches = [];
																for (i = 0; i <
												...
												fix: function(event) {
													...
													copy = fixHook.props ? this.props.concat(fixHook
														.props) : this.props;
												...
												keyHooks: {
													...
													filter: function(event, original) {
														if (event.which == null) {
															event.which = original.charCode !=
																null ? original.charCode : original
																.keyCode
														}
														return event
													}
												...
												mouseHooks: {
													props: "button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement"
														.split(" "),
													filter: function(event, original) {
														var body, eventDoc, doc, button = original
															.button,
														...
														if (event.pageX == null && original
															...
															event.pageX = original.clientX + (doc &&
																doc.scrollLeft || body && body
																.scrollLeft || 0) - (doc && doc
																.clientLeft || body && body
																.clientLeft || 0);
															event.pageY = original.clientY + (doc &&
																doc.scrollTop || body && body
																.scrollTop || 0) - (doc && doc
																.clientTop || body && body
																.clientTop || 0)
														}
														if (!event.relatedTarget && fromElement) {
															event.relatedTarget = fromElement ===
																event.target ? original.toElement :
																fromElement
														}
												...
												special: {
													...
													focus: {
														trigger: function() {
															if (this !== safeActiveElement() && this
																.focus) {
																try {
																	this.focus();
																	return false
											...
											jQuery.Event = function(src, props) {
												...
												if (src && src.type) {
													...
													this.isDefaultPrevented = (src.defaultPrevented ||
															src.returnValue === false || src
															.getPreventDefault && src
											...
											if (!jQuery.support.changeBubbles) {
												jQuery.event.special.change = {
													...
													handle: function(event) {
														...
														if (this !== elem || event.isSimulated ||
															event.isTrigger || (elem.type !==
											...
											jQuery.fn.extend({
												on: function(types, selector, data, fn, one) {
													...
													if (typeof types === "object") {
														...
														for (type in types) {
															this.on(type, selector, data, types[
																type], one)
														}
														return this
													}
													...
													if (one === 1) {
														...
														fn.guid = origFn.guid || (origFn.guid =
															jQuery.guid++)
													}
													return this.each(function() {
												...
												off: function(types, selector, fn) {
													...
													return this.each(function() {
														jQuery.event.remove(this, types,
															fn, selector)
													})
												},
											...
											jQuery.fn.extend({
												find: function(selector) {
													...
													ret = this.pushStack(len > 1 ? jQuery
														.unique(ret) : ret);
													ret.selector = this.selector ? this
												...
												is: function(selector) {
													return !!winnow(this, typeof selector ===
														"string" && rneedsContext.test(
												...
												closest: function(selectors, context) {
													...
													for (; i < l; i++) {
														for (cur = this[i]; cur && cur !==
															...
															if (cur.nodeType < 11 && (pos ? pos
																	.index(cur) > -1 : cur
																	.nodeType === 1 && jQuery
																	.find.matchesSelector(cur,
																		selectors))) {
																cur = ret.push(cur);
																break
															}
													...
													return this.pushStack(ret.length > 1 ?
												...
												index: function(elem) {
													...
													if (typeof elem === "string") {
														return jQuery.inArray(this[0], jQuery(
															elem))
													}
													return jQuery.inArray(elem.jquery ? elem[
														0] : elem, this)
												},
												add: function(selector, context) {
													var set = typeof selector === "string" ?
														jQuery(selector, context) : jQuery
														.makeArray(selector && selector
															.nodeType ? [selector] : selector),
														all = jQuery.merge(this.get(), set);
													return this.pushStack(jQuery.unique(all))
												},
												addBack: function(selector) {
													return this.add(selector == null ? this
											...
											jQuery.each({
												...
												contents: function(elem) {
													return jQuery.nodeName(elem, "iframe") ?
														elem.contentDocument || elem
														.contentWindow.document : jQuery.merge(
														[], elem.childNodes)
												}
											}, function(name, fn) {
											...
											jQuery.extend({
												filter: function(expr, elems, not) {
													...
													return elems.length === 1 && elem
														.nodeType === 1 ? jQuery.find
														.matchesSelector(elem, expr) ? [elem] :
														[] : jQuery.find.matches(expr, jQuery
											...
											function winnow(elements, qualifier, not) {
												...
												return jQuery.grep(elements, function(elem) {
													return (jQuery.inArray(elem, qualifier) >=
														0) !== not
												})
											}
											...
											var nodeNames =
												...
												fragmentDiv = safeFragment.appendChild(document
													.createElement("div"));
											wrapMap.optgroup = wrapMap.option;
											wrapMap.tbody = wrapMap.tfoot = wrapMap.colgroup = wrapMap
											...
											jQuery.fn.extend({
												...
												append: function() {
													return this.domManip(arguments, function(
														elem) {
														if (this.nodeType === 1 || this
															.nodeType === 11 || this
															.nodeType === 9) {
															var target =
																manipulationTarget(this,
																	elem);
												...
												remove: function(selector, keepData) {
													...
													for (;
														...
														if (elem.parentNode) {
															if (keepData && jQuery.contains(elem
																	.ownerDocument, elem)) {
												...
												empty: function() {
													...
													for (;
														...
														if (elem.options && jQuery.nodeName(
																elem, "select")) {
												...
												domManip: function(args, callback,
													...
													var first, node, hasScripts, scripts, doc,
														fragment, i = 0,
														l = this.length,
														set = this,
														iNoClone = l - 1,
											...
											function manipulationTarget(elem, content) {
												return jQuery.nodeName(elem, "table") && jQuery.nodeName(
													content.nodeType === 1 ? content : content
													.firstChild, "tr") ? elem.getElementsByTagName(
													"tbody")[0] || elem.appendChild(elem.ownerDocument
											...
											function setGlobalEval(elems, refElements) {
												...
												for (;
													(elem = elems[i]) != null; i++) {
													jQuery._data(elem, "globalEval", !refElements || jQuery
														._data(refElements[i], "globalEval"))
												}
											}
											...
											function fixCloneNodeIssues(src, dest) {
												...
												if (nodeName === "script" && dest.text !== src.text) {
													...
													dest.defaultSelected = dest.selected = src
														.defaultSelected
											...
											function getAll(context, tag) {
												var elems, elem, i = 0,
													...
													core_strundefined ? context.getElementsByTagName(tag ||
														"*") : typeof context.querySelectorAll !==
													core_strundefined ? context.querySelectorAll(tag ||
													"*") : undefined;
												if (!found) {
												...
												return tag === undefined || tag && jQuery.nodeName(context,
													tag) ? jQuery.merge([context], found) : found
											}
											...
											jQuery.extend({
												clone: function(elem, dataAndEvents,
													deepDataAndEvents) {
													var destElements, node, clone, i,
														srcElements, inPage = jQuery.contains(
															elem.ownerDocument, elem);
													if (jQuery.support.html5Clone || jQuery
														.isXMLDoc(elem) || !rnoshimcache.test(
															"<" + elem.nodeName + ">")) {
														clone = elem.cloneNode(true)
													} else {
														fragmentDiv.innerHTML = elem.outerHTML;
														fragmentDiv.removeChild(clone =
															fragmentDiv.firstChild)
													}
													if ((!jQuery.support.noCloneEvent || !jQuery
															.support.noCloneChecked) && (elem
															.nodeType === 1 || elem.nodeType ===
												...
												buildFragment: function(elems, context, scripts,
													selection) {
													var j, elem, contains, tmp, tag, tbody,
														wrap, l = elems.length,
													...
													for (; i < l; i++) {
														...
														if (elem || elem === 0) {
															if (jQuery.type(elem) ===
																...
																wrap = wrapMap[tag] || wrapMap
																	._default;
																tmp.innerHTML = wrap[1] + elem
																	.replace(rxhtmlTag,
																		"<$1></$2>") + wrap[2];
																j = wrap[0];
																while (j--) {
											...
											function isHidden(elem, el) {
												elem = el || elem;
												return jQuery.css(elem, "display") === "none" || !jQuery
											...
											function showHide(elements, show) {
												...
												for (index = 0; index < length; index++) {
													...
													if (!show || elem.style.display === "none" || elem.style
														.display === "") {
											...
											jQuery.extend({
												...
												style: function(elem, name, value, extra) {
													if (!elem || elem.nodeType === 3 || elem
														.nodeType === 8 || !elem.style) {
														return
													}
													var ret, type, hooks, origName = jQuery
														.camelCase(name),
														style = elem.style;
													name = jQuery.cssProps[origName] || (jQuery
														.cssProps[origName] =
														vendorPropName(style, origName));
													hooks = jQuery.cssHooks[name] || jQuery
														.cssHooks[origName];
													if (value !== undefined) {
														type = typeof value;
														if (type === "string" && (ret = rrelNum
																.exec(value))) {
															value = (ret[1] + 1) * ret[2] +
												...
												css: function(elem, name, extra, styles) {
													...
													if (val === "normal" && name in
														cssNormalTransform) {
														val = cssNormalTransform[name]
													}
													if (extra === "" || extra) {
														num = parseFloat(val);
														return extra === true || jQuery
															.isNumeric(num) ? num || 0 : val
													}
													return val
												}
											});
											if (window.getComputedStyle) {
												...
												curCSS = function(elem, name, _computed) {
													var width, minWidth, maxWidth, computed =
														_computed || getStyles(elem),
														ret = computed ? computed.getPropertyValue(
														name) || computed[name] : undefined,
														style = elem.style;
													if (computed) {
														if (ret === "" && !jQuery.contains(elem
																.ownerDocument, elem)) {
														...
														if (rnumnonpx.test(ret) && rmargin.test(name)) {
															...
															style.minWidth = style.maxWidth = style
																.width = ret;
															ret = computed.width;
															style.width = width;
												...
												curCSS = function(elem, name, _computed) {
													var left, rs, rsLeft, computed = _computed ||
														getStyles(elem),
											...
											function augmentWidthOrHeight(elem, name, extra, isBorderBox,
												styles) {
												var i = extra === (isBorderBox ? "border" : "content") ? 4 :
													name === "width" ? 1 : 0,
													val = 0;
												for (; i < 4; i += 2) {
													if (extra === "margin") {
											...
											function getWidthOrHeight(elem, name, extra) {
												var valueIsBorderBox = true,
													...
													.offsetHeight,
													styles = getStyles(elem),
													isBorderBox = jQuery.support.boxSizing && jQuery.css(
												...
												if (val <= 0 || val == null) {
													...
													valueIsBorderBox = isBorderBox && (jQuery.support
												...
												if (!display) {
													...
													if (display === "none" || !display) {
														iframe = (iframe || jQuery(
															...
															"display:block !important")).appendTo(doc
															.documentElement);
														doc = (iframe[0].contentWindow || iframe[0]
											...
											function actualDisplay(name, doc) {
												var elem = jQuery(doc.createElement(name)).appendTo(doc
														.body),
											...
											if (!jQuery.support.opacity) {
												jQuery.cssHooks.opacity = {
													get: function(elem, computed) {
														return ropacity.test((computed && elem
																.currentStyle ? elem
																.currentStyle.filter : elem
																.style.filter) || "") ? (0.01 *
																parseFloat(RegExp.$1)) + "" :
															computed ? "1" : ""
													},
													set: function(elem, value) {
														var style = elem.style,
															...
															"",
															filter = currentStyle && currentStyle
															.filter || style.filter || "";
														style.zoom = 1;
														if ((value >= 1 || value === "") && jQuery
											...
											jQuery(function() {
												...
												if (!jQuery.support.pixelPosition && jQuery.fn
													.position) {
											...
											if (jQuery.expr && jQuery.expr.filters) {
												jQuery.expr.filters.hidden = function(elem) {
													return elem.offsetWidth <= 0 && elem.offsetHeight <=
														0 || (!jQuery.support.reliableHiddenOffsets && (
											...
											jQuery.fn.extend({
												...
												serializeArray: function() {
													return this.map(function() {
														...
														var type = this.type;
														return this.name && !jQuery(
																this).is(":disabled") &&
															rsubmittable.test(this
																.nodeName) && !
											...
											jQuery.param = function(a, traditional) {
												...
												if (traditional === undefined) {
													traditional = jQuery.ajaxSettings && jQuery
														.ajaxSettings.traditional
												}
												if (jQuery.isArray(a) || (a.jquery && !jQuery
														.isPlainObject(a))) {
											...
											jQuery.each((
												...
												jQuery.fn[name] = function(data, fn) {
													return arguments.length > 0 ? this.on(name,
														null, data, fn) : this.trigger(name)
												}
											});
											jQuery.fn.extend({
											...
											function ajaxExtend(target, src) {
												var deep, key, flatOptions = jQuery.ajaxSettings
													.flatOptions || {};
												for (key in src) {
												...
												if (self.length > 0) {
													jQuery.ajax({
														...
														self.html(selector ? jQuery("<div>")
															.append(jQuery.parseHTML(
																responseText)).find(
																selector) : responseText)
													}).complete(callback && function(jqXHR,
													status) {
														self.each(callback, response || [jqXHR
											...
											jQuery.extend({
												...
												ajaxSetup: function(target, settings) {
													return settings ? ajaxExtend(ajaxExtend(
															target, jQuery.ajaxSettings),
														settings) : ajaxExtend(jQuery
														.ajaxSettings, target)
												},
												...
												ajax: function(url, options) {
													...
													options = options || {};
													var parts, i, cacheURL,
														responseHeadersString, timeoutTimer,
														fireGlobals, transport, responseHeaders,
														s = jQuery.ajaxSetup({}, options),
														callbackContext = s.context || s,
														globalEventContext = s.context && (
															callbackContext.nodeType ||
															callbackContext.jquery) ? jQuery(
													...
													s.type = options.method || options.type || s
														.method || s.type;
													...
													if (s.crossDomain == null) {
														...
														s.crossDomain = !!(parts && (parts[
															1] !== ajaxLocParts[1] ||
															parts[2] !== ajaxLocParts[
															2] || (parts[3] || (parts[
																1] === "http:" ?
																"80" : "443")) !== (
																ajaxLocParts[3] || (
													...
													if (s.data && s.processData && typeof s
														.data !== "string") {
														s.data = jQuery.param(s.data, s
															.traditional)
													}
													...
													if (s.ifModified) {
														if (jQuery.lastModified[cacheURL]) {
															jqXHR.setRequestHeader(
																"If-Modified-Since", jQuery
																.lastModified[cacheURL])
														}
														if (jQuery.etag[cacheURL]) {
															jqXHR.setRequestHeader(
																"If-None-Match", jQuery
																.etag[cacheURL])
														}
													}
													if (s.data && s.hasContent && s
														.contentType !== false || options
														.contentType) {
														jqXHR.setRequestHeader("Content-Type", s
															.contentType)
													}
													jqXHR.setRequestHeader("Accept", s
														.dataTypes[0] && s.accepts[s
															.dataTypes[0]] ? s.accepts[s
															.dataTypes[0]] + (s.dataTypes[
															0] !== "*" ? ", " + allTypes +
															"; q=0.01" : "") : s.accepts[
															"*"]);
													for (i in s.headers) {
											...
											function ajaxHandleResponses(s, jqXHR, responses) {
												var firstDataType, ct, finalDataType, type, contents = s
													.contents,
											...
											jQuery.ajaxTransport("script", function(s) {
												if (s.crossDomain) {
													var script, head = document.head || jQuery(
											...
											jQuery.ajaxSetup({
												...
												jsonpCallback: function() {
													var callback = oldCallbacks.pop() || (jQuery
														.expando + "_" + (ajax_nonce++));
													this[callback] = true;
													return callback
												}
											});
											jQuery.ajaxPrefilter("json jsonp", function(s, originalSettings,
												...
												var callbackName, overwritten, responseContainer,
													jsonProp = s.jsonp !== false && (rjsonp.test(s
															.url) ? "url" : typeof s.data ===
														"string" && !(s.contentType || "").indexOf(
													...
													if (!s.crossDomain || jQuery.support.cors) {
														...
														return {
															send: function(headers, complete) {
																...
																if (s.mimeType && xhr
																	.overrideMimeType) {
																	xhr.overrideMimeType(s
																		.mimeType)
																}
																if (!s.crossDomain && !headers[
																		"X-Requested-With"]) {
																	headers[
																		"X-Requested-With"] =
																		"XMLHttpRequest"
												...
												tweeners = {
													"*": [function(prop, value) {
														var tween = this.createTween(prop, value),
															...
															unit = parts && parts[3] || (jQuery
																.cssNumber[prop] ? "" : "px"),
															start = (jQuery.cssNumber[prop] ||
																unit !== "px" && +target) && rfxnum
															.exec(jQuery.css(tween.elem, prop)),
															scale = 1,
															maxIterations = 20;
														if (start && start[3] !== unit) {
															...
															do {
																...
																jQuery.style(tween.elem, prop,
																	start + unit)
															} while (scale !== (scale = tween
																.cur() / target) && scale !== 1 &&
																--maxIterations)
														}
														if (parts) {
															start = tween.start = +start || +
																target || 0;
															tween.unit = unit;
															tween.end = parts[1] ? start + (parts[
																1] + 1) * parts[2] : +parts[2]
														}
														return tween
													}]
											...
											function createTween(value, prop, animation) {
												var tween, collection = (tweeners[prop] || []).concat(
														tweeners["*"]),
													index = 0,
													length = collection.length;
												for (; index < length; index++) {
													if ((tween = collection[index].call(animation, prop,
															value))) {
														return tween
													}
												}
												...
												var result, stopped, index = 0,
													...
													animation = deferred.promise({
														...
														createTween: function(prop, end) {
															var tween = jQuery.Tween(elem, animation
																.opts, prop, end, animation.opts
																.specialEasing[prop] ||
														...
														stop: function(gotoEnd) {
															var index = 0,
																length = gotoEnd ? animation.tweens
																.length : 0;
															if (stopped) {
																return this
															}
											...
											function defaultPrefilter(elem, props, opts) {
												...
												if (elem.nodeType === 1 && ("height" in props || "width" in
														props)) {
													opts.overflow = [style.overflow, style.overflowX, style
														.overflowY
													];
													if (jQuery.css(elem, "display") === "inline" && jQuery
														.css(elem, "float") === "none") {
											...
											Tween.prototype = {
												...
												run: function(percent) {
													...
													if (this.options.duration) {
														this.pos = eased = jQuery.easing[this
															.easing](percent, this.options
															.duration * percent, 0, 1, this
															.options.duration)
													} else {
												...
												_default: {
													get: function(tween) {
														...
														if (tween.elem[tween.prop] != null && (!
																tween.elem.style || tween.elem
																.style[tween.prop] == null)) {
													...
													set: function(tween) {
														...
														} else if (tween.elem.style && (tween.elem
																.style[jQuery.cssProps[tween
																.prop]] != null || jQuery.cssHooks[
																	tween.prop])) {
											...
											Tween.propHooks.scrollTop = Tween.propHooks.scrollLeft = {
												set: function(tween) {
													if (tween.elem.nodeType && tween.elem
														.parentNode) {
														tween.elem[tween.prop] = tween.now
													}
												}
											...
											jQuery.each(["toggle", "show", "hide"], function(i, name) {
												...
												callback) {
													return speed == null || typeof speed ===
														"boolean" ? cssFn.apply(this,
											...
											jQuery.fn.extend({
												...
												animate: function(prop, speed, easing, callback) {
													...
													return empty || optall.queue === false ?
														this.each(doAnimation) : this.queue(
											...
											jQuery.speed = function(speed, easing, fn) {
												var opt = speed && typeof speed === "object" ? jQuery
													.extend({}, speed) : {
														complete: fn || !fn && easing || jQuery
															.isFunction(speed) && speed,
														duration: speed,
														easing: fn && easing || easing && !jQuery
															.isFunction(easing) && easing
													};
												opt.duration = jQuery.fx.off ? 0 : typeof opt
													.duration === "number" ? opt.duration : opt
													.duration in jQuery.fx.speeds ? jQuery.fx.speeds[opt
											...
											jQuery.fx.start = function() {
												if (!timerId) {
													timerId = setInterval(jQuery.fx.tick, jQuery.fx
														.interval)
												}
											};
											...
											jQuery.fn.offset = function(options) {
												if (arguments.length) {
													return options === undefined ? this : this.each(
														function(i) {
												...
												win = getWindow(doc);
												return {
													top: box.top + (win.pageYOffset || docElem
														.scrollTop) - (docElem.clientTop || 0),
													left: box.left + (win.pageXOffset || docElem
														.scrollLeft) - (docElem.clientLeft || 0)
												}
											};
											jQuery.offset = {
												setOffset: function(elem, options, i) {
													...
													if (options.left != null) {
														props.left = (options.left - curOffset
															.left) + curLeft
													}
													if ("using" in options) {
											...
											if (typeof module === "object" && module && typeof module
												.exports === "object") {
						...
						function zdztsp() {
							(function() {
								if (!obj.match(/^https?:\/\/(?:3g|m)\./) && (document.querySelector(
										"\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") != null)) {
									setTimeout(function() {
										try {
											...
											var hasAutoPlaySourcesWhitelist = autoPlaySourcesWhitelist
												.length > 0;
											var hasAutoPlaySitesWhitelist = autoPlaySitesWhitelist
												.length > 0;
											var lastClickTimeMs = 0;

											function isUrlMatch(url, pattern) {
												var regex = "https?:\/\/[a-zA-Z0-9\.\-]*?\.?" + pattern
													.replace(/\./, "\.") + "\/";
											...
											function isAutoPlayAllowedForSite(url) {
												if (hasAutoPlaySitesWhitelist) {
													for (var i = 0; i < autoPlaySitesWhitelist
														.length; i++) {
											...
											function isPlaying(vid) {
												return !!(vid.currentTime > 0 && !vid.paused && !vid
													.ended && vid.readyState > 2)
											}
											...
											if (pauseOnLeaveTab) {
												safeAddHandler(document, tabVisibleChangedEventName,
													onTabVisibleChanged)
											}
											...
											function isAutoPlayAllowedForSource(url) {
												if (hasAutoPlaySourcesWhitelist) {
													for (var i = 0; i < autoPlaySitesWhitelist
														.length; i++) {
														if (isUrlMatch(url, hasAutoPlaySourcesWhitelist[
																i])) return true
													}
												}
												return false
											...
											function onPlayOrLoaded(e, isPlayConfirmed) {
												...
												var vid = e.target;
												if (msSinceLastClick >
													allowAutoPlayWithinMillisecondsOfClick && !
													isAutoPlayAllowedForSource(vid.currentSrc)) {
													pauseVideo(vid)
												} else {
													vid.isPlaying = isPlayConfirmed ||
														treatPlayingLikeOnPlay
												}
											}
						...
						async function cssobj(css) {
							document.head.insertAdjacentHTML("beforeend",
								'<style type="text/css" class="cssobj-jiangxiaobai" media="screen">' + css +
								"{display:none!important;max-width:0!important;max-height:0!important;overflow:hidden!important;position:absolute;left:-102030px}</style>"
								);
						};
						...
						async function qpobj(quanping) {
							try {
								...
								var requestMethod = element.requestFullScreen || element
									.webkitRequestFullScreen || element.mozRequestFullScreen || element
									.msRequestFullscreen;
								if (requestMethod) {
									try {
						...
						let jxbtupiana =
							"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAMCAMAAACHgmeRAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAbUExURX//AIH8BobyGoT/CZP/J4nxIIL5C5T8LJj0PW2hJpgAAAAeSURBVAjXY2BlY4QABiZGBiigNouVGQoYONhZIAAAEpYAdsB2b4AAAAAASUVORK5CYII=";
						let jxbtupianb =
							"data:image/png;base64,";
						let jxbtupianc =
							"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAECAYAAACp8Z5+AAAAFUlEQVQImWPMPHPpPwMSYGJAA4QFAMZ5Aw4eXQtVAAAAAElFTkSuQmCC";
							...
							try {
								...
								setTimeout(function() {
									try {
										...
										document.querySelector("ul#httpsvipul>li:nth-child(" +
												arrhttpsjk + ")>span").style.backgroundImage = "url(" +
											jxbtupiana + ")";
									} catch (err) {}
									document.querySelector("ul#httpsvipul>li:nth-child(" + localStorage
										.getItem("httpsjk") + ")").click();
								}, 567);
						...
						function jxbzdjxobj() {
							...
							cssobj(
								'div.maomibtn li#vipjxtbli,div.maomibtn li#vipzdjxli{display:block!important}963540817');
							zdjyobj();
						};

						function bdvipzdjxobj() {
							if ((localStorage.getItem("vipzdjx") != null || localStorage.getItem("vipzdjx") ===
								"1")) {
								vipzdjx = localStorage.getItem("vipzdjx");
							} else {
								localStorage.setItem("vipzdjx", "2");
						...
						function jxbzdjxhyobj() {
							if (localStorage.getItem("vipzdjx") == '1') {
								...
								zdjyobj();
								cssobj(
									'div.maomibtn li#vipjxtbli,div.maomibtn li#vipzdjxhyli{display:block!important}963540817');
							}
						};
						...
						function jxqtwzhyobj() {
							bdtbobj();
							cssobj(
								'div.maomibtn li#vipjxtbli{display:block!important}div.maomibtn li>a[target="_blank"]:not([class="maomi"]):not([href*="//wpa.qq.com/msgrd"]):not([href*="/00/raw/master/"])');
						};
						...
						function apddjobj() {
							...
							let pdssgjcobj_jiankong = setInterval(function() {
								...
								if (pdssgjcobj_btn) {
									window.location.href = document.querySelector(pdssgjcobj +
										':first-child').href;
								...
								try {
									...
									let videovolumec_jiankong = setInterval(function() {
										try {
											if (document.getElementsByTagName("video")[0]) {
												let v_player = document.getElementsByTagName("video");
												for (let i = 0, length = v_player.length; i <
													length; i++) {
													v_player[i].pause();
													v_player[i].volume = 0;
												}
												...
												return false
													...
													"embed,object,iframe[frameborder]")) {
												let v_player = document.querySelectorAll(
													"embed,object,iframe[frameborder]");
												for (let i = 0, length = v_player.length; i <
													length; i++) {
						...
						function jxqzsxobj() {
							try {
								if (document.querySelector("iframe#江小白")) {
									document.querySelector("div#江小白").innerHTML =
										'<img id="江小白" src="https://api.btstu.cn/sjbz/zsy.php" marginwidth="0" marginheight="0" width="100%" height="100%" style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;">';
								} else if (document.querySelector("img#江小白")) {} else {
									if (!document.querySelector("jxbvideo") && !document.querySelector(
											"\u6c5f\u5c0f\u767d\u662f\u6211")) {
										document.body.appendChild(document.createElement("江小白是我"));
										try {
											if (document.querySelector("div#江小白>iframe#江小白")) {} else if (document
												.querySelector("div#江小白>img#江小白")) {} else {
												(function() {
													try {
														pausetimer = setInterval(function() {
															try {
																if (document.getElementsByTagName(
																		"video")[0]) {
																	var v_player = document
																		.getElementsByTagName("video");
																	for (var i = 0, length = v_player
																			.length; i < length; i++) {
																		try {
																			try {
																				v_player[i].paused;
									...
									for (let e = new Array("a", "img"), n = 0; n < 2; n++) {
										...
										if (i && i.length > 0)
											for (let a = 0; a < i.length; a++) {
												let l = i[a],
													s = l.getAttribute("id"),
													d = l.getAttribute("class");
												d && "A" == l.tagName && -1 != d.indexOf("; ") && l
													.getAttribute("onclick") && l.getAttribute("target") && l
													.href && (l.style.display = "none"), s && d && s == d && d
													.length > 10 && "LI" == l.tagName && (l.style.display =
														"none"), s && (s.length > 30 && -1 == s.indexOf("-") &&
														(l.style.display = "none"), /^[0-9]*$/.test(s) && s
														.length > 1 && (l.style.display = "none"), s.length >
														7 && /[0-9]/.test(s) && /[a-z]/i.test(s) && l
														.getAttribute("style") && (l.style.display = "none")),
													s && d && (-1 != d.indexOf(" ") && -1 != d.indexOf(s) && l
														.getAttribute("style") && (l.style.display = "none"),
														s == d && /[0-9]/.test(s) && /[a-z]/i.test(s) && (l
															.style.display = "none"))
											}
									}
								})();
						...
						if (jxbpcobj) {
							...
							function jxbjkspbfjsobj() {
								(function() {
									if (!document.querySelector(
										...
										if (objj.match(/(?:m1907|4321s)\./)) {} else {
											document.body.appendChild(document.createElement(
												"\u6c5f\u5c0f\u767d\u76d1\u63a7\u89c6\u9891\u64ad\u653e\u7ed3\u675f"
												));
											try {
							...
							if (jxbpclwobj) {
								cssobj(
									'div#jxbhttps{top:70px!important;left:5px!important;transform:scale(0.5)!important;}ul#httpsvipul>li{margin:-7.5px -17.5px -7.5px -17.5px!important;transform:scale(0.75)!important;}ul#httpsvipul{top:115px!important;width:450px!important;}963540817');
							} else {}

							function jszdqc() {
								setTimeout(function() {
									try {
										if (GM_getValue('集数').match(/^\s*?\d+?\s*?$/) && !GM_getValue('集数')
											.match(/^\s*?选集\s*?$/)) {
											GM_setValue('集数', '选集')
										} else {}
									} catch (err) {}
							...
							if (obj.match(
									/^https?:\/\/(?:v(?:-wb)?\.youku\.com\/v_show\/id_|vku\.youku\.com\/live\/)/)) {
								/* 电脑网站脚本设置 */
								...
								cssobj(
									'div[class^="u-app_"],div[class^="top_area"],.td-interactbox,.td-play__baseinfo,[class*="playbase"],[data-spm*="foot"],[data-js*="Down"],[class*="td-side-bar"] li:not([data-js-gotop*="gotop"])');
								cssobj(
									'[class*="login"][class*="pop"],[id*="login"][id*="pop"]{z-index:2147483648!important}963540817');
							} else if (obj.match(
									/^https?:\/\/v\.qq\.com\/(?:x\/(?:cover|page)|variety\/p\/topic)\//)) {
								/* 腾讯-脚本设置 */
								if (!obj.match(/\/x\/page\//)) {
									zdymyypdobj();
									jxbzdjxobj();
									...
									if (localStorage.getItem("vipzdjx") == '1' || localStorage.getItem("vipzdjx") ==
										'2') {
										cssobj(
											'[data-role^="txp-"][data-role*="-error"],[class*="mod_vip_popup"],[id*="mod_vip_popup"]');
									} else {}
									if (localStorage.getItem("vipzdjx") == '1') {
										jxbvolumebobj();
									} else {}
								...
								if (localStorage.getItem("vipzdjx") != '1') {
									setTimeout(function() {
										if (localStorage.getItem("vipzdjx") == '0' || localStorage.getItem(
												"vipzdjx") == '2') {
											(function() {
												let qqzdgbyla_counter = 0;
												let qqzdgbyla_jiankong = setInterval(function() {
													let qqzdgbyla_btn = document.querySelector(
														'[aria-label*="音量"]');
													if (qqzdgbyla_btn) {
														try {
															if (document.querySelector(
																	'[data-status="mute"]')) {
																$(".txp_popup_volume").css(
																	"display", "block");
																document.querySelector(
																		'[data-status="mute"]')
																	.click();
								...
								if (!obj.match(/^https?:\/\/www\.mgtv\.com\/act\//)) {
									...
									cssobj(
										'html,body{background:none!important;background-color:#1b1b1b!important;}div.wp-main.wp.page-section{margin-top:calc(10vh);}a.u-post{width:auto!important;}div.screen-top,[class*="qrcode"],div.mitem-index.mitem,div[class="c-header-panel-mod"]:not([id="honey-header-user"])');
									(function() {
										$("body").on('mouseover',
											'a[class*="listbox"][href*=".mgtv.com/"]:not([href*="=http"]):not([href*="?http"]):not([href*="#http"])',
											function(e) {
												let jxbzqxjobj = $(this),
													href = jxbzqxjobj.attr('href') || jxbzqxjobj.data(
														"href");
								...
								cssobj(
									'mango-control-status,.m-report-tipoff-dialog,[class*="footer"],[class*="mgad_"],[id*="mgad_"],ul.menu.clearfix a:not([href*="/show/"]):not([href*="/tv/"]):not([href*="/movie/"]):not([href*="/cartoon/"]):not([href*="/vip/"]),[class*="rightnav"] ul li:not([mg-stat-mod*="history"]):not([class*="user"])');
								cssobj(
									'div.mms-wrap,.control-right,[style*="top: 0px;left:0px;bottom:0px;right:0px"],[style*="top: 0px; left: 0px; bottom: 0px; right: 0px"],span[class$="bg"],.video-info.enable,.play-control .control-left .dos,.g-play .g-container-playcet .mod-wrap-side,.big-poster-conent,ul.honey-feedback-list li:not([class*="backtop"])');
								cssobj(
									'.u-control-danmu-control.state-bottom{right:25%!important;text-align:center;}div.maomibtn li#mgzdgqli{display:block!important}div.login-main{z-index:2000000000!important;}963540817');
								...
								if (iqiyibliwaiobj) {
									...
									lkzdztobj();
									cssobj(
										'div[class^="qy-header-login-pop-v"][class$=" selected"],[id*="_game"],[id*="_appDown"],[class^="player-mnb-left"],[class^="player-mnb-right"],aside[class="detail-sd"],ul[class="scroll-anchor"],div[data-player-hook^="shot-entrance"]');
									...
									if (localStorage.getItem("vipzdjx") == '1' || localStorage.getItem("vipzdjx") ==
										'2') {
										cssobj(
											'[class*="player"][class*="vip"][class*="popup"],[id*="player"][id*="vip"][id*="popup"]');
									} else {}
									if (localStorage.getItem("vipzdjx") == '1') {
										jxbvolumebobj();
									} else {}
								...
								lkzdztobj();
								cssobj(
									'.main-content{padding-bottom:inherit;}[class*="vip-side-wrap"],[id*="vip-side-wrap"],.tw-play-con,.tw-play-side,.tw-play-tag,.tw-play-num,.tw-play-intro,.collect');
								...
								cssobj(
									'a[target*="_blank"][pb-click]:not([title]):not([data-title]),[class^="x-"][class*="hot"][class$="-btn"],[class^="x-clock"],[class^="x-webg"],[class^="x-pugc-title"],[class^="x-gradient-top"],[class^="x-info-panel"],#newplayNavCrumbs,.seeBox,div#content,.x_poster_card,.side-set,div.mod-column-main.l,[class*="share"],[id*="share"],div[class^="vBox vBox-"]');
								cssobj(
									'[class*="foot"],[id*="foot"],[data-pb-txid*="qianfan"],[class*="zhibo"],#tvphb,span.btn-tips,a[class*="-adv-"][target*="_blank"],a[id*="-adv-"][target*="_blank"],.ad,.adv,#ad,#adv,.x-hdr-btn,.x-fox-btn,#leftBar,div.side-set div,div.side-set a:not([class*="top"]),div#navLocker div:not([class*="history"]):not([class*="upload"]):not([class*="user"]):not([class*="login"])');
								cssobj(
									'html{background-color:#313136;}div.mod-column-side.r,div.right{width:inherit!important;}div#toolBar{text-align:center;width:calc(100vw/2)!important;}div[class^="globallogin"]{z-index:2000000000!important;}#player{z-index:999999999!important;}963540817');
								...
								if (localStorage.getItem("vipzdjx") == '1' || localStorage.getItem("vipzdjx") ==
									'2') {
									cssobj(
										'[class*="play-end-pop],[id*="play-end-pop],[class*="player-bg"],[id*="player-bg"],[class*="play-end-overlay"],[id*="play-end-overlay"]');
								} else {}
								if (localStorage.getItem("vipzdjx") == '1') {
									jxbvolumebobj();
								} else {}
								cssobj(
									'#江小白{position:relative!important;}div[class^="globallogin"]{z-index:2000000000!important;}[class^="pop-operates"],[id^="pop-operates"]');
								cssobj(
									'#go-top,.visible.J_vip_buttons_info.movie-info-vip-wrap,i.nav-new,a[href*="film.sohu.com/vip.html"],a[href*="film.sohu.com/vipAct.html"],div.player-content-bg,div.top_template,div.tm-wel1,.x-info-panel,.x-gradient-top,.x-hdr-btn,.x-fox-btn,div.content_main_hasrank,div.bg_main,.footer');
								...
								if (localStorage.getItem("vipzdjx") == '1' || localStorage.getItem("vipzdjx") ==
									'2') {
									cssobj(
										'[class*="play"][class*="box"][class*="vipTip"],[id*="play"][id*="box"][id*="vipTip"]');
								} else {}
								if (localStorage.getItem("vipzdjx") == '1') {
									jxbvolumebobj();
								} else {}
								cssobj(
									'[style^="position:"][style*="hidden"],.hv_topbar,.vipTabBanner,[data-statectn*="right"],.hv_buy,.tj_title,#j-hotguess,div.rank_box,.Foot,.user_bar .user_vip,.player-content-bg,.pop-operates,.QR_code,[class^="Banner_"],[id^="Banner_"],[class^="JS_banner_"],[id^="JS_banner_"],[id^="JS_banner_"]+div.column_title,[id^="JS_banner_"]+div.column_title+div.column_body,[id^="JS_banner_"]+div.column_title~div.column_title,[id^="JS_banner_"]+div.column_title+div.column_body~div.column_body');
								cssobj('div#LEPass_LOGIN_IFRAME{z-index:2000000000!important;}963540817');
								remove(
									'.rightFix_tool,iframe[onload*="union"],[style^="position:"][style*="hidden"],[class="x-screenshot-btn"]');
								...
								if (localStorage.getItem("vipzdjx") == '1' || localStorage.getItem("vipzdjx") ==
									'2') {
									cssobj(
										'[class*="tryOver"],[id*="tryOver"]{opacity:0;}[class*="tryOver"]>iframe,[id*="tryOver"]>iframe');
								} else {}
								if (localStorage.getItem("vipzdjx") == '1') {
									jxbvolumebobj();
								} else {}
								cssobj(
									'a#update_btn,.button-box .right,img[class^="roll-"],img[id^="roll-"],a[tj_id],[class^="module-video"][class$="newupload"],[class*="copyright"],[class*="banneradv"],#video-maincont,[id*="game"],[class*="side-adv"],[class^="afp-"],[id^="afp-"],[class^="afp_"],[id^="afp_"]');
								cssobj(
									'.buy_vod.down.login-a-tryover,.focusPeople,div#wxPop,[tj_id^="sb_"],[class*="download"],[class^="module-video"][class$="-ops cf"],div.sus-cont a,div.sus-cont li:not([class*="top"]),div.hot.cf a:not([href*="tv.pptv."]):not([href*="movie.pptv."]):not([href*="zongyi.pptv."]):not([href*="cartoon.pptv."])');
								...
								cssobj(
									'div[class="qrcode_r fl"],div.player-widget,ul.ecope_emailsuggest,iframe#bubbleMsg,.pay-mod-notlogin,.playerBox-info-rightPart,#zhichiBtnBox,[class^="fl popBox ele_uc ticket hidden"],figure,footer,#sideBar_help_webSite,[class*="-adver"],[id*="-adver"]');
								...
								if (localStorage.getItem("vipzdjx") == '1' || localStorage.getItem("vipzdjx") ==
									'2') {
									cssobj(
										'[class*="player"][class*="vip"][class*="box"],[id*="player"][id*="vip"][id*="box"]');
								} else {}
								if (localStorage.getItem("vipzdjx") == '1') {
									jxbvolumebobj();
								} else {}
								...
								cssobj(
									'form#postFrameData,div[style^="position:absolute; right:0;"],div#play_mask,.playli_momey,.playli_erwm,.open_vip,.wasu_jh,.play_video_b,ws-postershot,[class*="postershot"],[id*="AD_POP_"],iframe[src*="adload"],.play_global,.footer,.sidebar,[class*="_ad"],[id*="_ad"],[class*="ad_"]:not([class*="head"]),[id*="ad_"]:not([id*="head"])');
								...
								if (!obj.match(/\/activity/)) {
									...
									if (obj.match(/^https?:\/\/www\.bilibili\.com\/bangumi\/play\//)) {
										...
										pcjkzdyj();
										jxzdqpobj();
										if (localStorage.getItem("vipzdjx") == '1' || localStorage.getItem(
												"vipzdjx") == '2') {
								...
								cssobj(
									'.fxp-video-cover,#mark-,#main-rt,.fix.rightBtn,span.tit-btn-icon,[class*="downlaod"],[class*="vipbg"]');
								cssobj(
									'a.orange-btn.js-pay-open{text-align:center!important}div[class^="dialog-view"]{z-index:2000000000!important;}963540817');
								...
								cssobj(
									'div[class="teleplay__playerContainer__wrapper"]{z-index:2000000000!important;}div.maomibtn a#jxbkjj,div[class="teleplayPage__interactionZone__LeftActions"],div[class="teleplay__LvideoRecomment"],a[href*="/www.ixigua.com/app/"],[class*="follow-guide"]');
							} else if (obj.match(
									/^https?:\/\/(?:www\.acfun\.cn\/(?:.+?\/ac|bangumi\/)|live\.acfun\.cn\/live\/)/
									)) {
								/* AcFun-脚本设置 */
								zdgbdmobj();
								lkzdztobj();
								...
								lkzdztobj();
								cssobj(
									'div.maomibtn li#ckkjjjobjli,li.land-item:nth-child(n+10),[class*="ownload"],[id*="ownload"],div[class="videoinfo-text clearfix"]>div,div[class="videoinfo-text clearfix"]>span:not([class*="left"])');
										...
										if (!document.getElementById("seBwhA") && document.title.indexOf(
											...
											$(document).ready(function() {
												...
												update_site_online_sites = function(title, en) {
													var i, l, link, link_parsed, n, name,
														site_online_sites;
													title = encodeURI(title);
													site_online_sites = {
														'布米米': 'http://www.bumimi99.com/search/' +
															title,
														'麻花影视': 'https://www.jiaomh.com/search.php?searchword=' +
															title,
													...
													for (name in site_online_sites) {
														...
														link.attr('target', '_blank').attr('rel',
															'nofollow');
														link.addClass('available');
														link.html(name);
														$('#content div.site-online-body ul')
															.append(link)
													}
												};
												site_online.addClass('site_online');
												site_online.find('div.c-aside-body').addClass(
													'site-online-body');
												site_online.find('h2 i').text('搜索播放');
												$('#content div.tags').before(site_online);
												var title, title_en, title_sec;
												title = title_sec = $('#content>h1>span')[0].textContent
													.split(' ');
												title = title.shift();
								...
								(function() {
									try {
										...
										pcjxbdbobj.innerHTML = '<a href="https://z1.m1907.cn/?jx=' + pcjxbdbobj
											.innerText.replace(/^\s*?(.+?第[^部季][部季]).*$/, "$1").replace(
												/^\s*?(?!.+?第[^部季][部季])(.+?)(?:\s+?(?:第)?.*)?$/, "$1") +
											'" onclick="window.open(this.href,\'bkmk_popup\',\'esizable=1,scrollbars=1,toolbar=0,status=0,width=1100,height=600,allowfullscreen=allowfullscreen,left=\'+(screen.availWidth-1100)/2+\',top=\'+(screen.availHeight-600)/2);return false" title="解析观看--' +
											pcjxbdbobj.innerText.replace(/^\s*?(.+?)\(.+?\).*$/, "$1") +
											'--资源">' + pcjxbdbobj.innerText.replace(/^\s*?(.+?)\(.+?\).*$/,
												"$1") + '</a><span class="year">' + pcjxbdbobj.innerText
											.replace(/^\s*?.+?(\(.+?\)).*$/, "$1") + '</span>';
									} catch (err) {
										return false;
									}
									...
									/^https?:\/\/(?:www\.bumimi.+?\/search\/|[^\/]+?\/(?:tv|acg|mov)\/)/)) {
								/* 布米米-脚本设置 */
								function bmmsc() {
									try {
								...
								if (obj.match(/^https?:\/\/www\.bumimi.+?\/search\//)) {
									...
									setTimeout(function() {
										...
										try {
											if (document.querySelector("#result").innerText.match(
													/抱歉\s*?[,，]\s*?未找到相关视频/)) {
												window.location.href = window.location.href.replace(
													/^.+?\/search\/(.*)$/,
													"https://www.jiaomh.com/search.php?searchword=$1");
											} else {}
										} catch (err) {}
									}, 1234);
									...
									setTimeout(function() {
										try {
											if (GM_getValue('集数').match(/^\s*?\d+?\s*?$/) && !GM_getValue(
													'集数').match(/^\s*?选集\s*?$/)) {
												window.location.href = document.querySelector(
														'ul:first-child>li>a[href$=".html"]:not([style])')
													.href.replace(/^(http.+?\/\d+?\/)\d+?(\.html).*$/,
														"$1" + GM_getValue('集数') + "$2");
												GM_setValue('集数', '选集');
											} else {
												GM_setValue('集数', '选集');
									...
									setTimeout(function() {
										try {
											let bmmmov = document.querySelector(
												'ul:first-child>li>a[href$=".html"]:not([style])');
											(bmmmov.innerText.match(/^\s*?正片\s*?\s*?/)) && (window.location
												.href = bmmmov.href);
										} catch (err) {}
									}, 1234);
									...
									setTimeout(function() {
										if (document.querySelector(
												'[class$=" clearfix"] a[href$=".html"]:not([style])') !=
											null) {} else {
											try {
												GM_setValue('集数', '选集');
											} catch (err) {}
									...
									/^https?:\/\/www\.jiaomh\.com\/(?:kmahua\/|search\.php\?searchword=)/)) {
								/* 麻花影视-脚本设置 */
								setTimeout(() => {
									if (obj.match(/\/search\.php\?searchword=/)) {
										try {
											if ($('ul[class="fed-list-info fed-part-rows"]>li').length ==
												1) {
												window.location.href = document.querySelector(
													'ul[class="fed-list-info fed-part-rows"]>li>a[href]:first-child'
													).href;
											} else {}
										} catch (err) {}
										try {
											if (document.querySelector(
													'ul[class="fed-list-info fed-part-rows"]').innerText
												.match(/对不起\s*?[,，]\s*?没有找到任何记录/)) {
												window.location.href = location.href.replace(
													/^.+?\/search\.php\?searchword=(.*)$/,
													"http://www.wbdy.tv/index.php?m=vod-search&wd=$1");
											} else {}
										} catch (err) {}
									} else {
										try {
											if ($('ul[class="fed-list-head fed-part-rows fed-padding"]')
												.length == 2) {
												if ($(
														'ul[class="fed-list-head fed-part-rows fed-padding"]>li:first-child')
													.length == 2) {
													if ($(
															'div[class="fed-tabs-boxs"] ul[class^="stui-content"][class*="playlist"][class$="clearfix"]>li')
														.length == 1) {
														if ($(
																'div[class="fed-tabs-boxs"] ul[class^="stui-content"][class*="playlist"][class$="clearfix"]>li>a[href]')
															.length == 1) {
															window.location.href = document.querySelector(
																'div[class="fed-tabs-boxs"] ul[class^="stui-content"][class*="playlist"][class$="clearfix"]>li>a[href]:first-child'
																).href;
														} else {}
													} else {}
												} else {}
								...
								if (obj.match(/\/\?s\//)) {
									if (document.querySelectorAll(
											'ul[class="stui-vodlist clearfix"]>li>a[href*="/?"]').length == 1) {
										try {
											if (GM_getValue('集数').match(/^\s*?\d+?\s*?$/) && !GM_getValue('集数')
												.match(/^\s*?选集\s*?$/)) {
												window.location.href = document.querySelector(
														'ul[class="stui-vodlist clearfix"]>li>a[href*="/?"]').href
													.replace(/^(http.+?\/\?p\/\d+?)(?:-\d+?)?(\.html).*/, "$1-" +
														GM_getValue('集数') + "$2");
												GM_setValue('集数', '选集');
											} else {
												window.location.href = document.querySelector(
									...
									zdbt();
									cssobj(
										'div.maomibtn li#ckkjjjobjli,div.maomibtn a.maomi+ul>li:not([style]):not([id])');
									setTimeout(function() {
										try {
											GM_setValue('集数', '选集');
										} catch (err) {}
										try {
											if (document.querySelector(
													'iframe[id="bofang"][src^="http"][src*="=http"]')) {
												try {
							...
							(function() {
								try {
									...
									let zdjkhttpsjk_jiankong = setInterval(function() {
										let zdjkhttpsjk_btn = document.querySelector(
											"ul#httpsvipul>li:last-of-type");
										if (zdjkhttpsjk_btn) {
											try {
												$('ul#httpsvipul>li').click(function() {
													try {
														document.getElementById('jjxxkka').style
															.display = 'none';
													} catch (err) {}
													if (document.querySelector(
															"ul#httpsvipul>li>span.wsjxbshhjd>a2"
															) == null) {} else {
														try {
															let httpsjksz = document
																.querySelector(
																	"ul#httpsvipul>li>span.wsjxbshhjd>a2"
																	).textContent;
															if (obj.match(
																...
																if (document.querySelector(
																		'ul#httpsvipul>li>span.wsjxbshhjd>a4'
																		).innerText.match(
																		new RegExp(
																			"^\s*?跳\s*?-"))) {
							...
							if (obj.match(/^https?:\/\/m\.youku\.com\/.+?\/id_/)) {
								...
								function sjykjxbzqobj() {
									cssobj(
										'.showMore,.brief-more,[sourcetype],[class^="brief-reserve"],[class^="h5-detail-feed"],div.x-trigger,div.uplader,#ykPlayer,.Push-container,.Corner-container,.h5-detail-ad,.h5-detail-guide.clipboard,.h5-detail-recommend,#comment-frame,.yk-footer,.brief-btm,#YKComment');
									if (localStorage.getItem("vipzdjx") == '1' || localStorage.getItem("vipzdjx") ==
										'2') {
										jxbvolumebobj();
									} else {}
								...
								if (!obj.match(/\/id_[a-zA-Z0-9]{12,18}(?:=?=?(?:$|\.html|[^a-zA-Z0-9]))/)) {
									(function() {
										try {
											...
											if (host.indexOf('youku.com') > -1 && ystr.indexOf(".html") > -1 &&
												ystr.length > 53 && ystr.indexOf("=") == -1) {
												let xm = document.querySelector(
													"DIV.anthologyStageStyle0.stageActive");
												if (xm) {
													xm.click()
												}
								...
								remove('iframe[data-sharesrc]');
								cssobj(
									'a#pay_href,section.actorModule.adContainer,section#exclusive_movie,section.app_search,section#fix_member,section#hot_movie,section#hot_telve,div#SOHUCS,.openApp,#app_store,.wakeAppBtn.fl,.openMembershipBtn,.downLoadBtn.commonPic,.open-app,.no-marg.f_song,.ad,.iconList');
								if (localStorage.getItem("vipzdjx") == '1' || localStorage.getItem("vipzdjx") ==
									'2') {
									jxbvolumebobj();
								} else {}
								...
								if (!obj.match(/^https?:\/\/m\.tv\.sohu\.com\/u\//)) {
									...
									cssobj(
										'.main-rec-view-box.main-view-box.app-view-box,.app-commentJS-box.app-vbox,.t_titlearrowup,.btn-xz-app');
								}
								if (obj.match(/^https?:\/\/m\.tv\.sohu\.com\/v/)) {
									cssobj(
										'[class^="x-download-"],.app-vbox-head a.extra,.app-vbox.app-star-vbox,.winbox-mask.__mask,.G-browser,.js-app-topbanner.actv-banner,.btn-xz-app,.ph-vbox.app-vbox,.app-guess-vbox.app-vbox,.main-rec-view-box.main-view-box.app-view-box,#CommentTarget,footer,.twinfo_iconwrap,.t_titlearrowup,.js-btn-newhy.btn-new-hy');
								} else if (obj.match(/^https?:\/\/m\.tv\.sohu\.com\/phone_play_film\?aid=/)) {
									cssobj(
										'.player_film_bg,.p_f_pannel,.btn-xz-app,.twinfo_iconwrap,#film_top_banner,.ph-vbox.app-vbox,.app-guess-vbox.app-vbox,.foot.sohu-swiper,#CommentTarget,footer,.player_film_cover,.t_titlearrowup');
								}
								...
								jxbzdjxhyobj();
								cssobj(
									'[class^="j-Banner"],[id^="j-Banner"],#j-leappMore,#j-zhoubian,#j-spoiler,#j-recommend,.leapp_btn,#j-toolbar>.animate1.column_box,.gamePromotionTxt,section#j-recommend,#j-comment,section.search_top,.footer,.intro_cnt dd,.up-letv');
								if (localStorage.getItem("vipzdjx") == '1' || localStorage.getItem("vipzdjx") ==
									'2') {
									jxbvolumebobj();
								} else {}
								...
								sjpdpthyobj = 1;
								cssobj(
									'div[class^="clearfix xx"],.appdown,.clearfix.player_menu_con,#gotop,.movie_title>.clearfix,.tele-play-rec.clearfix.ws_row.recommend,.hot-vcr,.ws_footer,div.navlist a:not([data-aliitemname*="电"]):not([data-aliitemname*="动"]):not([data-aliitemname="综艺"]):not([data-aliitemname="VIP"])');
								if (localStorage.getItem("vipzdjx") == '2') {
									jxbvolumebobj();
								} else {}
								...
								if (!obj.match(/^https?:\/\/(?:3g|m)\.v\.qq\.com\/.*?(?:[cv]id=|cover\/)/)) {
												...
												if (!document.querySelector("jxbsjqq")) {
													...
													try {
														...
														function sjqqgbdkfsobj() {
															try {
																if (document.querySelector(
																		'a[href*="/x/"]:not([target="_blank"])'
																		)) {
																	for (let i = 0, len = document
																			.querySelectorAll('a[href*="/x/"]')
																			.length; i < len; i++) {
									...
									jxbzdjxhyobj();
									cssobj(
										'[dt-params*="推荐"],[dt-params*="会员特权"],[open-app]:not(li),.video_function.video_function_new,.mod_source,.U_color_b.video_types_new.video_types,.mod_promotion,.mod_recommend.mod_box,.mod_clips.mod_box,.mod_comment.mod_box,.mod_multi_figures_h.mod_sideslip_h.mod_box,.mod_game_rec.mod_box');
									if (localStorage.getItem("vipzdjx") == '1' || localStorage.getItem("vipzdjx") ==
										'2') {
										jxbvolumebobj();
									} else {}
								...
								jxbzdjxhyobj();
								cssobj(
									'div.recom-wrapper,div[class*="footer"],[class^="bili-app"],[class^="open-app"]');
								if (localStorage.getItem("vipzdjx") == '1' || localStorage.getItem("vipzdjx") ==
									'2') {
									jxbvolumebobj();
								} else {}
								...
								jxbzdjxhyobj();
								cssobj(
									'div[id="mPlayer"]>img[class*="-bg-"]+div[class="acmplayer-wrapper"]~div[class="acmplayer-wrapper"],div[class^="js-"][class*="-fixed"],div[id^="js-"][id*="-fixed"],div[data-impr-config],div[class^="recommend"],div[id^="recommend"],div[class^="side-lights-"],div[class^="recommend-bangumi-"],div[class^="more-main-comment flex-"],div[class^="header-ico"],div[class="content"][id="recommend"],div[style^="visibility:"][style*="visible"]:not([class*="ist"]):not([id*="ist"]),span#vipzdjxhy');
							} else if (obj.match(/^https?:\/\/m\.douban\.com\/movie\/subject\//)) {
								/* 豆瓣-脚本设置 */
								cssobj(
									'div#subject-header-container{margin-top:50px!important;}div[class="sub-original-title"],section[class="subject-mark mark-movie"],a[class="write-comment"],a[class="write-review"],div.TalionNav-static,[class*="-banner"],.sub-vendor,.show-all,.score-write,section+div.center');
								(function() {
									try {
										let sjjxbaobj = document.querySelector(
												"#subject-header-container>div.sub-info div.sub-title"),
											sjjxbbobj = document.querySelector(
												"#subject-header-container>div.sub-info div.sub-original-title"
												);
										sjjxbaobj.innerHTML = '<a href="https://z1.m1907.cn/?jx=' + sjjxbaobj
											.innerText.replace(/^\s*?(.+?第[^部季][部季]).*$/, "$1").replace(
												/^\s*?(?!.+?第[^部季][部季])(.+?)(?:\s+?(?:第)?.*)?$/, "$1") +
											'" onclick="window.open(this.href,\'bkmk_popup\');return false">' +
											sjjxbbobj.innerText.replace(/^\s*?(.+?)\(.+?\).*$/, "$1") + '</a>';
									} catch (err) {
										return false;
									}
								})();
						...
						function jxbmmanzxobj() {
							if (objj.match(/(?:ximalaya|1ting|music)\./) && !objj.match(/music\.163\./)) {
								...
								cssobj(
									'[class="m-hmhot"]>[class="hotop"],[class="hotdn"],[class*="top"][class*="fr"],[class*="ft-fixed"],[class^="more-wrap"],[class^="cmt_more"],footer');
							} else {}
							if (obj.match(
									/^https?:\/\/(?!.+?\.(?:og[gv]|m(?:p[34]|4a)|w(?:ebm|av)|flv)($|\?.+))(?:music\.163\.com\/|y\.music\.163\.com\/m\/(?:song|dj)\?id=|(?:(?:bd|www)\.)?kuwo\.cn\/|m\.kuwo\.cn\/newh5|www\.kugou\.com\/(?:song|mvweb)\/|m3ws\.kugou\.com\/(?:kgsong|mv)\/|m\.kugou\.com\/|(?:i\.)?y\.qq\.com\/|(?:www|h|m)\.xiami\.com\/|(?:m\.)?music\.migu\.cn\/|5sing\.kugou\.com\/|(?:www|m)\.ximalaya\.com\/|kg\.qq\.com\/node\/|www\.app-echo\.com\/|radio\.sky31\.com\/|www\.1ting\.com\/|(?:www|m)\.9ku\.com\/play\/|www\.lrts\.me\/playlist|www\.douyin\.com\/video\/|www\.kuaishou\.com\/|haokan\.(?:baidu|hao123)\.com\/v)/
									)) {
								/* 猫咪按钮-脚本设置 */
								if (objj.match(/music\.163\./)) {
									cssobj(
										'div[class*="play"] a[href*="/artist?id="],[href*="/store/product"],#g-topbar>div.m-top li.lst,SPAN.u-btn u-btn-red,#btn-open-id,I.arr ani,DIV.m-musicStreetWakeUp');
								} else if (objj.match(/kuwo/)) {
									if (jxbpcobj) {
										cssobj(
											'[class*="foot"],[id*="foot"],[class*="copy"],[id*="copy"],[class^="qrcode-container"],[class*="xiuchang"]');
									} else {
										cssobj(
											'div[id="top"],[class^="Bottom_"],[class*="download"],[class^="nav_title"],[class="tokuwo"],div[class="Mvplay_getbutt"],[class="Progress_body"]~*,.top .right');
									}
								} else if (objj.match(/kugou/)) {
									if (jxbpcobj) {
										cssobj(
											'[aria-describedby*="down"],[class*="_banner_wrap"],[id*="_banner_wrap"],ul[class="subNav"],a[id="productCenter"],div[class="btnArea2 clearfix"],[class*="spread"]');
									} else {
										cssobj(
											'[class*="down"],[id*="down"],[class*="openAppBtn"],[id*="openAppBtn"],[class*="comment_more"],[id*="comment_more"],[class*="mod_singer"],[id*="mod_singer"],[class*="morelrc"],[id*="morelrc"]');
									}
								} else if (objj.match(/y\.qq\.com/)) {
									cssobj(
										'a[href^="javascript:"][class*="bottom"][class*="openplayer"]+div[class="popup_guide"],[class*="nav"][class*="own"],div[class^="lyric_action"],div[class^="flotage js_pg_flotage"],p[class="comment__rule"],div[id="limitButton"],[data-stat*="top.artists"],[data-tj*="_$qm"]:not([data-tj$="_$qm"]),[data-tj][data-ksongmid],[data-tj$="_$qm"]:not([data-tj*="yric"]):not([data-tj*="song"]):not([data-tj*="inger"]),[data-expose="songsheet_$qm"],[data-expose="video_$qm"]');
									...
									if (jxbpcobj) {} else {
										cssobj(
											'div[class^="video-player-shade"],div[class*="download"],div[class^="top-video-list-container"],div[class^="video-relate-list-container"],div[class^="gather"],div[class^="author-info"]');
									}
								} else if (objj.match(/\.9ku\.com/)) {
									cssobj(
										'li[id^="sprri"],[class^="xx"],[class="songText2"],fotter,iframe,[class^="fot"],[class^="dongBox "],a[class*="down"],[class^="you"],[style*="width: 960px"],[style*="width:960px"],[id^="asyncbox_"]');
								} else if (objj.match(/1ting\./)) {
									cssobj(
										'[class^="NA_"],[id^="NA_"],[class="todaySong"],[class^="tingx_"],[id^="tingx_"],div[class="main"][id="widget"],[style*="height:90px"],[style*="height: 90px"],[class^="mobile"],[id^="mobile"],a[href*="/mv/song/player/"],a[class*="nice"],li[id^="feedback"]');
									...
									cssobj(
										'a[class="yinliuBtn"][href^="javascript:"],section[class^="music-active"],section[id^="music-active"],[class="app-mv"],[class^="windowImg"]');
								} else if (objj.match(/ximalaya/)) {
									cssobj(
										'[class="box sY_"],a:not([to^="/"]):not([to^="http"])[to*="://open"],[class^="dl-pc "],[id^="dl-pc "],[class*="-card _"],[id*="-card _"],[href*="download"],[href*=".tmall.com"]');
								} else {}(function() {
									...
									btn.addEventListener('click', function() {
										if (obj.match(/music\.163\./)) {
											if (jxbpcobj) {
												try {
													if (document.querySelector(
															'a[hidefocus="true"][class="ply j-flag pas"]'
															)) {
														document.querySelector(
															'a[hidefocus="true"][class="ply j-flag pas"]'
															).click();
												...
												if (obj.match(
													...
													window.open(
														...
														'div[class*="play"] a[hidefocus="true"][href*="?id="]'
														).href.match(
														/^https?:\/\/music\.163\.com\/(?:song|dj)\?id=/
														)) {
													window.open(
														"https://music.163.com/song/media/outer/url?id=" +
														document.querySelector(
																			...
																			function() {
																				if (document
																					...
																					try {
																						document
																							.querySelector(
																								'a[hidefocus="true"][class="ply j-flag"]'
																								)
																							.click()
																					} catch (
																						err
												...
												if (document.querySelector(
														'div[class*="newfst"] div[class*="playing"]')) {
													try {
														if (document.querySelector(
																"div.m-song-clickarea.m-song-clickarea2"
																)) {
															document.querySelector(
																"div.m-song-clickarea.m-song-clickarea2"
																).click();
													...
													document.addEventListener('visibilitychange',
														function() {
															if (document.hidden) {} else if (!
																document.querySelector(
																	"div.m-song-clickarea.m-song-clickarea2"
																	)) {
																try {
																	document.querySelector(
																		"div.m-song-clickarea"
																		).click();
																} catch (err) {}
															} else {}
														})
											...
											try {
												if (document.querySelector('video>source')) {
													...
													window.open(document.querySelector('video>source')
														.src, "bkmk_popup");
												} else {}
											} catch (err) {}(function() {
												if (!document.querySelector("jxbyyxzjk")) {
												...
												/(?:haokan|kuaishou|kuwo|kugou|(?:y|kg)\.qq|xiami|migu|app-echo|radio\.sky31|lrts|9ku)\./
												)) {
											(function() {
												if (!document.querySelector("jxbyyxzjk")) {
													document.head.appendChild(document
											...
											if (!objj.match(/radio\.sky31\./)) {
												if (document.querySelectorAll("audio,video")[0].src
													...
													if (document.querySelector("video")) {
														...
														window.open(document.querySelector("audio").src,
															"bkmk_popup");
														return false;
													} else {
														return false;
												...
												if (document.querySelectorAll("audio")[0].src.match(
														new RegExp("^http"))) {
											...
											try {
												if (document.querySelector(
														'li[class="playing"]>input[type=checkbox][value][hidefocus="true"]'
														)) {
													try {
													...
													window.open(jxbyyxzaobj + document.querySelector(
														'li[class="playing"]>input[type=checkbox][value][hidefocus="true"]'
														).value + "&type=1ting", "bkmk_popup");
												} else {}(function() {
													if (!document.querySelector("jxbyyxzjk")) {
														document.head.appendChild(document
															.createElement("jxbyyxzjk"));
											...
											if (document.querySelector(
													'div[class*="player-body"]>a[class*="title"][href]:not([href="/"])'
													) && obj.match(/^https?:\/\/www\./)) {
												try {
													if (document.querySelector(
															'div[class*="player"] a[class="pause"]')) {
														document.querySelector(
																'div[class*="player"] a[class="pause"]')
															.click();
													} else {}
												...
												window.open(jxbyyxzaobj + document.querySelector(
													'div[class*="player-body"]>a[class*="title"][href]'
													).href.replace(/^https?:\/\/.*?\/(\d+)$/,
													"$1") + "&type=ximalaya", "bkmk_popup");
											} else if (document.querySelector(
													'i.icon-list_pause+.titleWrapper .title._Qw') && obj
												.match(/^https?:\/\/m\./)) {
												window.open(jxbyyxzaobj + document.querySelector(
														'i.icon-list_pause+.titleWrapper .title._Qw'
														).parentNode.parentNode.parentNode
													.parentNode.href.replace(
														/^https?:\/\/.*?\/(\d+)$/, "$1") +
													"&type=ximalaya", "bkmk_popup");
											} else if (document.querySelector(
													'div[class^="player-box"] a[to^="iting://open?msg_type="][to*="&track_id="]'
													) && obj.match(/^https?:\/\/m\./)) {
												window.open(jxbyyxzaobj + window.location.href.replace(
														/^https?:\/\/.*?\/(\d+)$/, "$1") +
													"&type=ximalaya", "bkmk_popup");
											} else {
												return false;
								...
								(function() {
									...
									let mmyydsfzx_jiankong = setInterval(function() {
										let mmyydsfzx_btna = document.querySelector(
											'span[class="am-input-group-btn"]>a[id="j-src-btn"][target="_blank"]'
											).href.match(new RegExp("^http"));
										let mmyydsfzx_btnb = document.querySelector("form input+div")
											.innerText.match(new RegExp("没有找到"));
										if (mmyydsfzx_btna) {
											if (document.querySelector(
													'span[class="am-input-group-btn"]>a[id="j-src-btn"][target="_blank"][href^="http"]:not([href$="="])'
													)) {
												window.location.href = document.querySelector(
													'span[class="am-input-group-btn"]>a[id="j-src-btn"][target="_blank"][href^="http"]:not([href$="="])'
													).href;
									...
									setTimeout(function() {
										if (jxbyyxzbobj == null || jxbyyxzbobj == undefined ||
											jxbyyxzbobj == '') {
											window.close()
										} else if (document.location.href.indexOf(jxbyyxzaobj) == 0) {
											window.location.href = window.location.href.replace(
												/^.+?=(\d+?)&type=(.*)$/, jxbyyxzbobj + "$1&type=$2"
												);
										} else {
											window.close()
										}
							...
							if (obj.match(/^https?:\/\/(?:www\.wbdy\.tv|www\.ikukk\.com)\//)) {
								if (obj.match(/^https?:\/\/[^\/]+?\/$/)) {} else {
									cssobj(
										'.navbar,.panel{border:none;margin-bottom:auto}.glyphicon-triangle-right:before,.glyphicon-play:before,ol.breadcrumb,nav,[role*="alert"],[class="panel-heading"],[class="panel-heading"]+[class="panel-body content"],[class="panel-footer"]');
									if (obj.match(/\/index.php\?m=vod-search/)) {
										...
										setTimeout(function() {
											...
											try {
												if (document.querySelector('div.panel-heading').innerText
													.match(/共\s*?0\s*?条/) || document.querySelector(
														'div.panel-footer.page').innerText.match(
														/共\s*?0\s*?条/)) {
													window.location.href = window.location.href.replace(
														/^.+?\/index\.php\?m=vod-search&wd=(.*)$/,
														"https://www.cupfox.com/search?key=$1");
												} else {}
											} catch (err) {}
										}, 1234);
										...
										if (obj.match(/\/play\//)) {
											(function() {
												setTimeout(function() {
													if (document.querySelector(
															'iframe[src*="/?url=&id="]') && !document
														.querySelector('iframe[src*="/?url=http"]')) {
														alert('当前集数还没更新，请自行更换 接口');
														window.close();
													} else if (document.querySelector(
															'iframe[src*="/?url=http"]') && !document
														.querySelector('iframe[src*="/?url=&id="]')) {
														return false;
													} else {
														return false;
													}
										...
										try {
											if (document.querySelector(
												...
												try {
													if (obj.match(
															/^https?:\/\/www\.wbdy\.tv\/play\/\d+?[^\/]+?\.html/) &&
														GM_getValue('集数').match(/^\s*?\d+?\s*?$/) && !GM_getValue(
															'集数').match(/^\s*?选集\s*?$/)) {
														window.location.href = window.location.href.replace(
															/^(http.+?\/play\/\d[^\/]+?_)\d+?(\.html).*$/,
															"$1" + GM_getValue('集数') + "$2");
														GM_setValue('集数', '选集');
													} else {
														try {
															if (GM_getValue('视频自动全屏').match(/^\s*?开启\s*?$/) && !
																GM_getValue('视频自动全屏').match(/^\s*?关闭\s*?$/) &&
																localStorage.getItem("jxzdqp") == '1') {
																setTimeout(function() {
																	qpobj(document.querySelector(
										...
										if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875")) {
											cssobj(
												'div.btn-list{width:auto!important;float:none!important;text-align:center!important;}.btn-group-sm>.btn,.btn-sm{font-size:unset;}963540817');
										} else {}
										try {
											const reg = /^[^\-]+?\-.*?在线/;
								...
								(function() {
									try {
										...
										for (let miao101i = 0; miao101i < miao101.length; miao101i++) {
											const miao101msa = miao101[miao101i].querySelectorAll(
												'a[href*="/video/"]');
											for (let miao101ia = 0; miao101ia < miao101msa
												.length; miao101ia++) {
												if (miao101msa[miao101ia].innerText.match(
														/^\s*?第\s*?\d+?\s*?集\s*?$/g)) {
													miao101msa[miao101ia].innerText = miao101msa[miao101ia]
														.innerText.replace(/^\s*?第\s*?0?(\d+?)\s*?集\s*?$/g,
															"$1")
												}
											}
										};
								...
								cssobj(
									'div[class*="nav"][class$="tabbar"],div[class^="col-md-wide-"][class*="-sidebar"],ul[class$="extra clearfix"],ul[class*="header"][class*="nav"]>li[class*="hidden-md hidden-sm hidden-xs"],[class*="foot"],[id*="foot"]');
								if (obj.match(/\/vodsearch\//)) {
									...
									setTimeout(function() {
										try {
											if (document.querySelector(
													"\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875")) {
												if (document.querySelectorAll("ul#searchList>li.clearfix")
													.length == 1) {
													if (GM_getValue('集数').match(/^\s*?\d+?\s*?$/) && !
														GM_getValue('集数').match(/^\s*?选集\s*?$/)) {
														window.location.href = document.querySelector(
															'ul#searchList>li.clearfix a[href*="/vodplay/"]'
															).href.replace(
															/^(http.+?\/vodplay\/[^\/]+?-)\d+?(\.html)/,
															"$1" + GM_getValue('集数') + "$2");
													} else {
									...
									cssobj(
										'body>:not(nav):not(header):not([class*="player"]):not([id*="player"]),div[id*="player"][id*="sidebar"] div[class^="col-"][class*="mb10"]>a[href]:not([href^="/"])>img,div.maomibtn li#ckkjjjobjli,div.maomibtn a.maomi+ul>li:not([style]):not([id])');
									cssobj(
										'.maomibtn{position:fixed!important;}body>:not(nav):not(header):not([class*="player"]):not([id*="player"])~div:not([class]):not([id]){display:block!important;max-width:none!important;max-height:none!important;overflow:auto!important;position:relative;left:auto;}963540817');
									setTimeout(function() {
										try {
											if (document.querySelector(
													"\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875")) {
										...
										if (document.querySelector(
												'table iframe[src*="https"][allowfullscreen]')) {
											try {
												if (document.querySelector(
														"\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") && (
														localStorage.getItem("jxzdqp") == '1')) {
									...
									/^https?:\/\/(?![^\/]*?cupfox\.(?:[^\/]+?\/$|.+?&id=))[^\/]*?cupfox\./)) {
								jkdsflyobj();
								localStorage.setItem('websiteTime', '20');
								cssobj(
									'script+p,[class*="img"],[id*="img"],img,[class$="search-other-names"],div>[style^="z-index:"],[class*="block"],[class$="movie border-shadow"],[class*="sidebar"],ul[class$="fixed-nav"],div[class$=" nav"]>span:not([class*="title"]):not([class*="xuanpian"]):not([class*="bangdan"]),img[width*="%"],[class$="movie border-shadow"]+[style^="z-index:"],[class$="title-wrapper"]~[class$="mobile-detail-block"],[class$="fixed-nav"]+[class$="movie border-shadow"],[class$="mobile-container"]+[class$="mobile-nav"],[class$="card border-shadow"],[class*="burger-button"],[id^="page-wrap"]>[style^="z-index:"],[id^="hjuj"]');
							} else {}
						};
						if (vipzdjxwzobj) {
							(function() {
								...
								let aa = 1,
									bb = '<span><a1 style="display:none"></a1><a2 style="display:none">',
									cc = '<span><a1 style="color:darkgreen">搜索</a1><a2 style="display:none">',
									dd = '<span><a1 style="color:darkgreen">跳转</a1><a2 style="display:none">',
									ee = '<span><a1 style="color:darkgreen">小窗</a1><a2 style="display:none">',
									eee =
									'<span style="background-color:cyan"><a1 style="color:darkgreen">Json</a1><a2 style="display:none">',
									ff = '<span><a1 style="color:darkgreen">大窗</a1><a2 style="display:none">',
									ii =
									'<span style="background-color:hotpink"><a1 style="color:darkgreen"></a1><a2 style="display:none">',
									kk =
									'<span style="display:grid;background-color:skyblue;font-weight:bold;border:5px outset buttonface;border-radius:5px;"><a1 style="border:5px outset buttonface;border-radius:5px;">小白自用</a1><a2 style="display:none">',
									jj =
									'<span style="background-color:darkorange"><a1 style="color:darkgreen"></a1><a2 style="display:none">',
									gg =
									'</a2><a3 style="color:#2196F3;zoom:0.8;font-weight:bold;">\u27bd</a3><a4>',
									hh = '</a2><a3 style="display:none"></a3><a4>',
									https = [{
										name: bb + aa++ + hh + "\u900f\u660e\u65e0\u63a5\u53e3",
										vip: "\u900f\u660e\u65e0\u63a5\u53e3"
									}, {
										...
										name: cc + aa++ + gg + "\u89c6\u9891\u9009\u96c6",
										vip: "\u89c6\u9891\u9009\u96c6"
										/* ** 原网页解析接口存放处 ** 只支持 https 接口类型 ** 根据以下格式，自己添加接口** */
									}, {
										name: jj + aa++ + hh + "M19",
										...
										name: jj + aa++ + hh + "福星",
										url: "https%3A%2F%2Fjx.668game.cn%2Ffuxing%2F%3Furl%3D"
									}, {
										name: ii + aa++ + hh + "乐乐",
										...
										name: ii + aa++ + hh + "可乐",
										url: "https%3A%2F%2Fapi.lanmaody.com%2Fdm%2F%3Furl%3D"
									}, {
										name: ii + aa++ + hh + "虾米",
										...
										name: ii + aa++ + hh + "扶风",
										url: "https%3A%2F%2Fpo.91kan.site%2F%3Furl%3D"
									}, {
										name: ii + aa++ + hh + "夜幕",
										url: "aHR0cHM6Ly93d3cueWVtdS54eXovP3VybD0="
									}, {
										name: ii + aa++ + hh + "巴陵",
										url: "https%3A%2F%2F80k.tv%2Fplayer%2F%3Furl%3D"
									}, {
										name: ii + aa++ + hh + "哔哩",
										url: "https%3A%2F%2Fwww.mtosz.com%2Fm3u8.php%3Furl%3D",
										title: "B站可以用"
										/* *********备用解析接口存放处***********根据以下格式，自己添加接口**** */
									}, {
										name: bb + aa++ + hh + "PAR",
										...
										name: bb + aa++ + hh + "盘古",
										url: "https%3A%2F%2Fwww.pangujiexi.cc%2Fjiexi.php%3Furl%3D"
									}, {
										name: bb + aa++ + hh + "乐多",
										url: "https%3A%2F%2Fapi.leduotv.com%2Fwp-api%2Fifr.php%3FisDp%3D1%26vid%3D"
									}, {
										name: bb + aa++ + hh + "锦云",
										url: "https%3A%2F%2Fgo.yh0523.cn%2Fy.cy%3Furl%3D"
									}, {
										name: bb + aa++ + hh + "淘影",
										url: "https%3A%2F%2Fjx.vodjx.top%2Fm3u8%2F%3Furl%3D"
									}, {
										name: bb + aa++ + hh + "奇米",
										...
										name: bb + aa++ + hh + "芒果",
										url: "https%3A%2F%2Fwww.mgtv.pro%2F%3Furl%3D"
									}, {
										name: bb + aa++ + hh + "猝然",
										...
										name: bb + aa++ + hh + "四看",
										url: "https%3A%2F%2Fdd.ojbkjx.com%2Fplayer4%2Fm3u8.php%3Furl%3D"
									}, {
										name: bb + aa++ + hh + "酷吧",
										...
										name: bb + aa++ + hh + "璇玑",
										url: "https%3A%2F%2Fcdn.dtjug.cn%2F%3Furl%3D"
									}, {
										name: bb + aa++ + hh + "乌玛",
										...
										name: ee + aa++ + gg + "大师",
										url: "https%3A%2F%2Fwww.ifreefans.com%2Fjx2%2F%3Furl%3D",
										vip: "强制弹小窗"
									}, {
										name: dd + aa++ + gg + "方案",
										...
										name: cc + aa++ + gg + "旋风视频",
										vip: "旋风视频" /*},{name:cc+aa+++gg+"Youtube",vip:"Youtube",title:"需要 科学上网 环境"*/
									}, {
										name: cc + aa++ + gg + "麻花影视",
										vip: "麻花影视"
									}, {
								...
								function createSelecthttps(https) {
									...
									if (jxbpcobj) {
										...
										httpsvipul.setAttribute("style",
											"display:none;background:#18222d;width:99vw;max-width:728px;height:150px;margin:0;padding:0;position:fixed;bottom:7px;left:50%;transform:translateX(-50%);z-index:99999;overflow-x:hidden;overflow-y:auto;scrollbar-width:none;-webkit-overflow-scrolling:touch;border-radius:5.3px;"
											);
									}
									for (var i = 0; i < https.length; i++) {
										let httpsvipli = document.createElement("li");
										if (jxbpcobj) {} else {
											httpsvipli.setAttribute("style",
												"width:23%;padding:0 1px 0 1px;margin:0;border-radius:10px;display:block;list-style:none;float:left;font-size:16px;color:#999!important;font-weight:900;height:47.5px;text-align:center;line-height:63.5px;letter-spacing:0;border-bottom:0.5px solid #333;position:relative;overflow:hidden;text-overflow:hidden;white-space:nowrap;cursor:pointer;"
												);
										}(function(num) {
											try {
												if (document.querySelector(
														"\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875")) {
													if (https[num].name.match(
															/(?:\u900f\u660e\u65e0\u63a5\u53e3|\u81ea\u52a8\u55c5\u63a2)/g
															)) {} else {
														if (https[num].url != null || https[num].url !=
															undefined) {
															if (https[num].title != null || https[num]
																.title != undefined) {
																try {
																	httpsvipli.title =
																		'\u7279\u522b\u8bf4\u660e\uff1a\uff08' +
																	...
																	httpsvipli.title =
																		...
																		https[num].title +
																		'\uff09\u203b \u63a5\u53e3\u5730\u5740\uff1a\uff08' +
																		unescape(https[num].url.replace(
																				/^[^:\/]*?(https?:\/\/)/igm,
																				"$1").replace(/%20/gm, "")
																			.replace(/\s{1,}/gm, "")) +
																		'\uff09';
														...
														if (https[num].url == null || https[num].url ==
															...
															if (https[num].title == null || https[num]
																.title == undefined) {
																httpsvipli.title = https[num].name.replace(
																	/^.+?>\s*?([^<]+?)\s*?<\/a1>.+?<a4>\s*?(.+)\s*?$/gm,
																	"使用“$2”进行$1");
															}
															if (https[num].title != null || https[num]
											...
											httpsvipli.onclick = function() {
												try {
													...
													(function() {
														if (!document.querySelector("jxbvideo")) {
															document.body.appendChild(document
																.createElement("jxbvideo"));
															try {
																if (document.querySelector(
																		"\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875"
																		)) {
																	const sjjkslobj = document
																		.querySelectorAll(
																			"#httpsvipul>li");
																	let arra = [],
																		arrb = [],
																		arrahttpsjk, arrbhttpsjk;
																	for (let sjjksloji =
																		0; sjjksloji < sjjkslobj
																		.length; sjjksloji++) {
																		if ((sjjkslobj[sjjksloji]
																				.style.display !=
																				'none') && (
																				sjjkslobj[sjjksloji]
																				.querySelector('a1')
													...
													let arr = ["1", "2", "3", "4", "5", "6", "7", "8",
														...
														bxjImg = Math.floor(Math.random() * arr.length),
														jxbimg = atob(
															"aHR0cHM6Ly9jZW8zMC5jb2RpbmcubmV0L3AvcHRwdC9kL3B0L2dpdC9yYXcvbWFzdGVyLw=="
															) + arr[bxjImg] + atob("LmpwZw==");
													var jxbjxurl, jjxxaa, jjxxbb, jjxxcc, jxb;
													jjxxbb = "aHR0cHM6Ly96eS5hb3h0di5jb20vP3VybD0=";
													try {
														jjxxcc = atob(jjxxbb.replace(
																/^[^:\/]*?(https?:\/\/)/igm, "$1")
															.replace(/%20/gm, "").replace(
																/\s{1,}/gm, ""));
													} catch (err) {
														jjxxcc = unescape(jjxxbb.replace(
																/^[^:\/]*?(https?:\/\/)/igm, "$1")
															.replace(/%20/gm, "").replace(
																/\s{1,}/gm, ""));
													}
													...
													let tctha =
														'<div id="江小白" style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;"><img id="江小白" src="https://api.btstu.cn/sjbz/" marginwidth="0" marginheight="0" width="100%" height="100%" style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;"></img></div>';
													let tcthb =
														'<div id="江小白" style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;"><img id="江小白" src="' +
														jxbimg +
														'" marginwidth="0" marginheight="0" width="100%" height="100%" style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;"></img></div>';
													try {
													...
													try {
														if (document.querySelector(
															...
															if (objj.indexOf('youku') > 0) {
																jxbjxurl = obj.replace(
																	/^.+?\/id_([^\.=]+?)==.*$/,
																	"http://v.youku.com/v_show/id_$1==.html"
																	).replace(/^https:\/\//,
																	"http://").replace(
																	/html[\W_].*?$/, "html");
																...
																function pcyoukudszx() {
																	...
																	if (!document.querySelector(
																		...
																		cssobj(
																			'#ykPlayer,.nav-mamu,[class*="error-layer"],[id*="error-layer"],[class*="preplay-background"],[id*="preplay-background"],[class*="vip_info"],[id*="vip_info"],[class*="vip_limit_box"],[id*="vip_limit_box"]');
																	}
																};
																...
																if (obj.indexOf('/x/cover/') > 0) {
																	jxbjxurl = obj.replace(
																		...
																		'/variety/p/topic/') > 0) {
																	jxbjxurl = document.querySelector(
																			".current .figure_title")
																		.offsetParent.href.replace(
																			/^https:\/\//, "http://")
																		.replace(/html[\W_].*?$/,
																			"html");
																		...
																		(function() {
																			try {
																				let aElement =
																					document
																					.querySelectorAll(
																						'[_wind*="列表"] ul li a[href*="/x/"][target]'
																						);
																				for (let i = 0; i <
																					aElement
																					.length; i++) {
																...
																function pcqqdszx() {
																	...
																	if (!document.querySelector("小江")) {
																		...
																		ggobj('#dark_layer');
																		ggallobj(
																			'div[class*="_vip_popup"]'
																			);
																		remove(
																			'txpdiv,[class*="poplay"],[id*="poplay"],[class^="x_"],[id^="x_"],[class^="mod_action "],[id^="mod_action "],[class*="_vip_popup"],[class*="_vip_popup"],[id*="_vip_popup"],script[crossorigin="anonymous"],[_r-component="player"],[_r-component="c-popups"]');
																		cssobj(
																			'.mod_player_section.cf{background-color:transparent}.mod_vip_popup.wrapper,.cf.mod_action,[data-role^="txp-"][data-role*="-error"],[class*="mod_vip_popup"],[id*="mod_vip_popup"]');
																	}
																};
																...
																if (obj.indexOf('mgtv.com/b/') > 0) {
																	...
																	if (!document.querySelector(
																		...
																		document.body.appendChild(
																			document.createElement(
																				"白小江"));
																		ggobj(
																			'#mgtv-player-wrap container');
																		cssobj(
																			'outer-bottom,container,[class*="player"][class*="paytips"],[id*="player"][id*="paytips"]');
																	}
																} else if (obj.indexOf(
																	'mgtv.com/act/') > 0) {
																	function pcmgtvdszx() {
																		try {
																			jxbjxurl = document
																				.querySelector(
																					'li[class^="play-item is-full is-"][class$=" on"]'
																					).getAttribute(
																					"data-vurl")
																				.replace(
																					/^.*?\/b\/(.+?)\.html.*$/ig,
																	...
																	if (!document.querySelector(
																		"#江小白") && document
																		.querySelector("ul.v-lists")) {
																		let qisdjxa = document
																			.querySelector(
																			"ul.v-lists");
																		qisdjxa.onclick = function(e) {
																			setTimeout(pcmgtvdszx,
																				pczdydssjobj);
																		};
																	} else {}
																}
																...
																function pciqiyidszx() {
																	...
																	if (!document.querySelector(
																		...
																		ggobj('#secondFrame');
																		remove(
																			'div#scrollTip,.qy-glide,#qy-glide,[class^="qy-glide"],[id^="qy-glide"],svg[display="none"][aria-hidden="true"],div[class*="player-side-ear"],div[class^="player-mnb"][data-asyn-pb]');
																		cssobj(
																			'[class*="player-vippay-popup"],div[style*="visibility"][style*="visible"]:not([class]):not([id]):not([style*="fixed"]),div[class*="player-side-ear"],div[class^="player-mnb"][data-asyn-pb],[class*="player"][class*="vip"][class*="popup"],[id*="player"][id*="vip"][id*="popup"]');
																	}
																};
																...
																if (obj.indexOf('iqiyi.com/v_') > 0) {
																	if (!document.querySelector("白江")) {
																		...
																		(function() {
																			$("body").on(
																				'mouseover',
																				'ul li [href*="/v_"][href*=".html"]:not([href*="=http"]):not([href*="?http"]):not([href*="#http"])',
																				function(e) {
																					let jxbzqxjobj =
																						$(this),
																						href =
																		...
																		try {
																			setTimeout(function() {
																				(document
																					.querySelector(
																						'a[href="javascript:void(0)"][rseat$="_listbox_positive"][class="select-link"]:not([data-href])'
																						)
																					.innerText ==
																					'更多') && (
																					document
																...
																} else if (obj.indexOf('iqiyi.com/a_') >
																	0 || obj.indexOf(
																	'iqiyi.com/kszt/') > 0) {
																	if (!document.querySelector("小江")) {
																		document.body.appendChild(
																		...
																		remove(
																			'div[class*="-list-box"][class*="-lianboList"],div[class$="-side-icon"],div[id*="scrollBox"],div[class*="tem_voteEnter"]');
																	}
																} else {}
															} else if (obj.indexOf('tv.sohu.com/v/') >
																0) {
																jxbjxurl = obj.replace(/^https:\/\//,
																	"http://").replace(
																	/html[\W_].*?$/, "html");
																	...
																	if (!document.querySelector(
																		...
																		document.body.appendChild(
																			document.createElement(
																				"白小江"));
																		cssobj(
																			'#player_vipTips,#toolBar,[class*="player"][class*="vipTips"],[id*="player"][id*="vipTips"]');
																	}
																};
																setTimeout(pcsohuadszx, pczdydssjobj);
															} else if (obj.indexOf(
																	'film.sohu.com/album/') > 0) {
																jxbjxurl = obj.replace(/^https:\/\//,
																	"http://").replace(
																	/html[\W_].*?$/, "html");
																...
																function pcsohubdszx() {
																	...
																	if (!document.querySelector(
																		...
																		remove(
																			'.player-content-bg,.pop-operates');
																		cssobj(
																			'[class*="play-end-pop],[id*="play-end-pop],[class*="player-bg"],[id*="player-bg"],[class*="play-end-overlay"],[id*="play-end-overlay"]');
																	}
																};
																...
																function pcpptvdszx() {
																	...
																	if (!document.querySelector(
																		...
																		ggobj('.sidebarbtn');
																		cssobj(
																			'div[class^="module-video"][class*="-ops"],[class*="tryOver"]>iframe,[id*="tryOver"]>iframe');
																	}
																};
																...
																function pcyjlwdszx() {
																	...
																	if (!document.querySelector(
																		...
																		ggobj('object');
																		remove(
																			'.sc-content,.sc-paper,.sc-error');
																		cssobj(
																			'.player-widget,[class^="sc-content clearfix"],[id^="sc-content clearfix"]');
																	}
																};
																...
																function pcwasudszx() {
																	...
																	if (!document.querySelector(
																		...
																		ggobj('.qp');
																		cssobj(
																			'div#pcplayer{height:100%;}.play_video_b,[class*="player"][class*="vip"][class*="box"],[id*="player"][id*="vip"][id*="box"]');
																	}
																};
																...
																jxbjxurl = obj.replace(
																	/^.+?\/(\w+)\/\?.*$/,
																	"http://www.bilibili.com/bangumi/play/$1"
																	).replace(/\?spm_id_.*?$/, "");
																...
																function pcbilibilidszx() {
																	...
																	if (!document.querySelector(
																		...
																		cssobj(
																			'[class^="player_mask"],[id^="player_mask"]');
																	}
																};
																setTimeout(pcbilibilidszx,
																pczdydssjobj);
																	...
																	if (!document.querySelector(
																		...
																		document.body.appendChild(
																			document.createElement(
																				"白小江"));
																		cssobj(
																			'[class^="play-Panel-Wrap"],[id^="play-Panel-Wrap"]');
																	}
																};
																setTimeout(pcfundszx, pczdydssjobj);
															} else if (objj.indexOf('.ixigua.com') >
																0) {
																jxbjxurl = obj.replace(/^https:\/\//,
																	"http://");
																	...
																	if (!document.querySelector("白江")) {
																		document.body.appendChild(
																			document.createElement(
																				"白江"));
																		try {
																			cssobj('.teleplayPage__playerSection__left,div[class="teleplay__playerContainer__wrapper"],div.teleplay__playerContainer__wrapper{height:' +
																				document
																				.querySelector(
																					"div.teleplay__playerContainer__wrapper"
																					).offsetHeight +
																				'px!important;width:' +
																				document
																				.querySelector(
																		...
																		cssobj(
																			'body{overflow-x:hidden!important;overflow-y:hidden!important;}div.teleplayPage__secondary,[class*="PlayEnding"],[id*="PlayEnding"]');
																	}
																	if (document.querySelector(
																	...
																	if (!document.querySelector("小江")) {
																		document.body.appendChild(
																			document.createElement(
																				"小江"));
																		remove(
																			'video,textarea,#player_default,[data-album-id],[data-episode-id]');
																		remove(
																			'div[style*="display:none"],div[style*="display: none"]');
																		remove(
																			'div[class="teleplayPage__secondary"],[src*="xigua_video_web_pc"]');
																		remove(
																			'div[data-version],script[id^="SSR_"],noscript');
																		remove(
																			'div[class*="FixedGroup"],div[class="teleplayPage__Description__tags"],div[class^="teleplayPage__Description__details"]');
																	}
																};
															...
															if (objj.indexOf('youku') > 0) {
																...
																if (localStorage.getItem("vipzdjx") !=
																	'2') {
																	setTimeout(sjmgtvdszx,
																	sjzdydssjobj);
																} else {
																	setTimeout(function() {
																		setTimeout(sjmgtvdszx,
																...
																function sjpptvdszx() {
																	if (document.querySelector(
																		...
																		vipobj('#playerbox');
																			...
																			'section[class*="mod_box"][class*="video"]'
																			)) {
																		vipobj(
																			'section[class*="mod_box"][class*="video"]');
																	} else {}
																	...
																	if (!document.querySelector("白江")) {
																		document.body.appendChild(
																			document.createElement(
																				"白江"));
																		try {
																			cssobj('section.column.playB{height:' +
																				document
																				.querySelector(
																					'section.column.playB'
																					).offsetHeight +
																				'px!important;}963540817'
																				);
																		} catch (err) {}
																	}
																	if (document.querySelector(
																...
																jxbjxurl = obj.replace(
																	/^.+?\/v_(.+?)\.html.*$/,
																	"http://www.iqiyi.com\/v_$1.html"
																	);

																function sjiqiyidszx() {
																	if (document.querySelector(
																			'div[time*=":"][class="m-box"]>div[style]:not([class]):not([id])'
																			)) {
																		if (document.querySelector(
																				'.m-box-items.m-box-items-full'
																				)) {
																			vipobj(
																				'.m-box-items.m-box-items-full');
																		} else {}
																		if (!document.querySelector(
																			...
																			remove(
																				'div[class="m-box"]:not([total-pages])');
																		}
																	} else if (document.querySelector(
																			'.m-video-player')) {
																	...
																	if (!document.querySelector("小江")) {
																		document.body.appendChild(
																			document.createElement(
																				"小江"));
																		cssobj(
																			'[name="m-videoInfo"]{margin-top:7.5%;}.m-video-player{background:black!important;}.m-video-player-wrap{top:-202px!important}963540817');
																		remove(
																			'[id*="open_app_iframe"],[style*="hidden"][style*="absolute"]');
																	}
																};
																			...
																			if (document.querySelector(
																				...
																				try {
																					if (!document
																						...
																						cssobj('section.mod_player{height:' +
																							document
																							.querySelector(
																...
																if (obj.match(/[cv]id=/)) {
																	jxbjxurl = obj.replace(
																		/^.+?cid=(\w+)(?:&vid=)?$/,
																		"http://v.qq.com/x/cover/$1.html"
																		).replace(
																		/^.+?cid=(\w+)&vid=(\w+).*$/,
																		"http://v.qq.com/x/cover/$1/$2.html"
																		).replace(
																		/^.+?\/(?![^\/]+?cid=)([^\/]+?)\.html\?vid=(\w+)$/,
																		"http://v.qq.com/x/cover/$1/$2.html"
																		);
																	setTimeout(sjqqdszx, sjzdydssjobj);
																		...
																		/^https?:\/\/(?!.+?[cv]id=).{1,}\/\d+?\/[a-z0-9]+?\/[a-z0-9]+?\.html/
																		)) {
																	jxbjxurl = obj.replace(
																		/^https?:\/\/(?!.+?[cv]id=).{1,}\/\d+?\/([a-z0-9]+?\/[a-z0-9]+?)\.html.*$/,
																		"http://v.qq.com/x/cover/$1.html"
																...
																if (!document.querySelector("小白江")) {
																	document.body.appendChild(document
																		.createElement("小白江"));
																	cssobj(
																		'.site_player_inner,#vipPosterContent');
																}
															} else if (objj.indexOf('bilibili') > 0) {
																jxbjxurl = obj.replace(
																	/^https?:\/\/m\.bilibili\.com\/bangumi\/play\/(\w*).*$/,
																	"http://www.bilibili.com/bangumi/play/$1"
																	);

																function sjbilibilidszx() {
																	if (document.querySelector(
																			'div.player-mask.relative'
																			)) {
																		vipobj(
																			'div.player-mask.relative');
																		if (!document.querySelector(
																			...
																			remove('div#bofqi');
																			cssobj(
																				'.player-mask img{-webkit-transform:none!important;-ms-transform:inherit!important;transform:none!important;-webkit-filter:none!important;filter:none!important;}963540817');
																		}
																	} else if (document.querySelector(
																			'div.player-wrapper')) {
																		try {
																			if (!document.querySelector(
																				...
																				document.body
																					.appendChild(
																						...
																						.createElement(
																							"小江"));
																				cssobj('div.player-wrapper{height:' +
																					document
																					.querySelector(
																						"div.player-wrapper"
																						)
																...
																setTimeout(sjbilibilidszx,
																sjzdydssjobj);
															} else if (objj.indexOf('acfun.cn') > 0) {
																jxbjxurl = obj.replace(/^https:\/\//,
																	"http://").replace(
																	/^.+?\/v\/\?\w+?=(\d+)(?:&.*)?$/,
																	"http://www.acfun.cn/bangumi/aa$1"
																	).replace(
																	/^.+?\/v\/\?\w+?=(\d+?)_(\d+)(?:&.*)?$/,
																	"http://www.acfun.cn/bangumi/aa$1_0_$2"
																	);
																if (document.querySelector(
																	'#mPlayer')) {
																	vipobj('#mPlayer');
													...
													function vipobj(vip) {
														try {
															if (document.querySelector("div#江小白") !=
																...
																if (document.querySelector("img#江小白") !=
																	null) {} else {
																	document.querySelector("div#江小白")
																		.remove();
																}
															} else {
																document.querySelector(vip).innerHTML =
																	document.querySelector(vip);
															}
														} catch (err) {}
														try {
															if (objj.match(/qq\./) && https[num].name
																.match(/(?:思古)/) && localStorage
																.getItem("vipzdjx") != null) {
																try {
																	jjxxaa = jjxxcc + atob(https[num]
																		.url) + jxbjxurl + https[
																		num].vip;
																} catch (err) {
																	jjxxaa = jjxxcc + unescape(https[
																			num].url) + jxbjxurl +
																		https[num].vip;
																}
															} else if (objj.match(
																	'(?:acfun|ixigua|fun)') || (
																	pcliwaiobj && localStorage.getItem(
																		"jxywyfsgbobj") != null & !(
																		sessionStorage.getItem(
																			"jxywygdfsgbobj") == '1')
																	)) {
																if (https[num].name.match(
																		/(?:久播|920|IK)/i) && !https[num]
																	.name.match(/强制(?:弹[小大]窗|跳转)/)) {
																	try {
																		jjxxaa = jjxxcc + atob(https[
																				num].url) + jxbjxurl +
																			https[num].vip;
																	} catch (err) {
																		jjxxaa = jjxxcc + unescape(
																				https[num].url) +
																			jxbjxurl + https[num].vip;
																	}
																} else {
																	try {
																		jjxxaa = atob(https[num].url) +
																			jxbjxurl + https[num].vip;
																	} catch (err) {
																		jjxxaa = unescape(https[num]
																				.url) + jxbjxurl +
																			https[num].vip;
																	}
																}
															...
															setTimeout(function() {
																...
																if (jxb.match(new RegExp(
																		...
																		new RegExp(
																			"(?:透明无接口|布米米|视频选集|米侠|Youtube|麻花影视|旋风视频|555电影|古云搜索)"
																			))) {
																	if (objj.match(
																			'(?:acfun|ixigua|fun)'
																			) || (pcliwaiobj &&
																		...
																		if (objj.match(
																			...
																			window.open(jxb,
																				"bkmk_popup",
																				"allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=" +
																				(screen
																					.availWidth -
																					screen
																					.availWidth *
																			...
																			window.open(jxb,
																				"bkmk_popup",
																				"allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left=" +
																				(screen
																					.availWidth -
																					1050) /
																				2 +
																					...
																					maomizdjxaobj
																						...
																						setInterval(
																							function() {
																								if (document
																									.querySelector(
																										'div.maomibtn>ul>li>ul>li>a[href*="//www.bumimi"]'
																										) !=
																									null
																									) {
																									try {
																					...
																					maomizdjxbobj
																						...
																						setInterval(
																							function() {
																								if (document
																									.querySelector(
																										'div.maomibtn>ul>li>ul>li>a[href*="://www.wbdy.tv"]'
																										) !=
																									null
																									) {
																									try {
																					...
																					maomizdjxcobj
																						...
																						setInterval(
																							function() {
																								if (document
																									.querySelector(
																										'div.maomibtn>ul>li>ul>li>a[href*="//www.youtube.com"]'
																										) !=
																									null
																									) {
																									try {
																										if (document
																											...
																											window
																												.open(
																													document
																													.querySelector(
																														'div.maomibtn>ul>li>ul>li>a[href*="//www.youtube."]'
																														)
																													.href,
																													"_blank"
																													);
																					...
																					maomizdjxeobj
																						...
																						setInterval(
																							function() {
																								if (document
																									.querySelector(
																										'div.maomibtn>ul>li>ul>li>a[href*="//www.jiaomh.com"]'
																										) !=
																									null
																									) {
																									try {
																					...
																					maomizdjxfobj
																						...
																						setInterval(
																							function() {
																								if (document
																									.querySelector(
																										'div.maomibtn>ul>li>ul>li>a[href*="//miao101.com"]'
																										) !=
																									null
																									) {
																									try {
																					...
																					maomizdjxgobj
																						...
																						setInterval(
																							function() {
																								if (document
																									.querySelector(
																										'div.maomibtn>ul>li>ul>li>a[href*="//www.555dy6.com"]'
																										) !=
																									null
																									) {
																									try {
																					...
																					maomizdjxhobj
																						...
																						setInterval(
																							function() {
																								if (document
																									.querySelector(
																										'div.maomibtn>ul>li>ul>li>a[href*="//pgso.cnjsjf.com"]'
																										) !=
																									null
																									) {
																									try {
														...
														if (localStorage.getItem("pcjkzdyj") ==
															'0') {} else {
															if (!document.querySelector(
																	"\u6211\u662f\u6c5f\u5c0f\u767d")) {
																document.body.appendChild(document
																		...
																		let zdjkhttpsjk_jiankong =
																			setInterval(function() {
																				...
																				if (
																					...
																					clearInterval
																						(
																							zdjkhttpsjk_jiankong);
																					return false
																				}++
																				zdjkhttpsjk_counter
																				;
																				if (zdjkhttpsjk_counter >
																					20) {
																					clearInterval
																						(
																							zdjkhttpsjk_jiankong);
								...
								if (jxbpcobj) {
									...
									function createMenuhttps() {
										...
										jxbhttps.id = "jxbhttps";
										jxbhttps.innerHTML =
											'<svg id ="vipsvg" style="font-weight:bold;cursor:pointer;bottom:50px;width:40px;height:40px;position:fixed;right:0.5vmin;z-index:100000;text-align:center;border-radius:10px;"</svg><svg viewBox="128 128 256 256"><path d="M422.6 193.6c-5.3-45.3-23.3-51.6-59-54 -50.8-3.5-164.3-3.5-215.1 0 -35.7 2.4-53.7 8.7-59 54 -4 33.6-4 91.1 0 124.8 5.3 45.3 23.3 51.6 59 54 50.9 3.5 164.3 3.5 215.1 0 35.7-2.4 53.7-8.7 59-54C426.6 284.8 426.6 227.3 422.6 193.6z"/><path d="M222.2 303.4v-94.6l90.7 47.3L222.2 303.4z" fill="#18222d"/></svg>';
										jxbhttps.setAttribute("style", "color:#008000;fill:#008000;");
										jxbhttps.onclick = function() {
											try {
												let httpsvipul = document.getElementById("httpsvipul"),
													jjxxkka = document.getElementById("jjxxkka"),
													vipsvg = document.querySelector("svg#vipsvg");
											} catch (err) {}
											httpsvipul.setAttribute('tabindex', '1');
											let redHide = document.getElementById('httpsvipul');
											try {
												if (httpsvipul.style.display == "none") {
													try {
														if (jjxxkka.style.display == "none") {
															try {
																document.querySelector("#jxbewanobj")
																.click();
															} catch (err) {}
															try {
											...
											if (localStorage.getItem("pcjkzdyj") == '0') {} else {
												(function() {
													...
													let pdjqjssfczobj_jiankong = setInterval(
												function() {
														let pdjqjssfczobj_btn = document
															.querySelector(
																"script#jiangxiaobaijqjs");
														if (pdjqjssfczobj_btn) {
															try {
																$('ul#httpsvipul>li').click(
																	function() {
																		try {
																			document
																				.getElementById(
											...
											if (httpsvipul.style.display == "none") {
												httpsvipul.style.display = "block";
												this.style.cssText +=
													"color:#cd7f32;fill:#cd7f32;background:0"
											} else {
												httpsvipul.style.display = "none";
									...
									try {
										...
										document.querySelector('#httpsvipul>li:last-of-type').setAttribute(
											'style', 'display:none!important');
									}(function() {
										try {
											const jxbqcsjjk = document.querySelectorAll('ul#httpsvipul li');
											let sjtzsjzdylwobj = /(?:法克|蓝影|冰豆|师兄|麻瓜|文笔|[教文方]案|挚爱|云栖)/,
												/* 手机端开放的跳接口 */ sjqjpbzdylwobj =
												/(?:垫片|爱读|猪蹄|大白|丝瓜|无尽|江湖|乐多|思古|历程|三二|17云|临时|时光|锦云|回响|夜空|1717|8090|唯多|无名|墨鱼|哔哩|淘影|诺讯|大亨|小蒋|玩嗨|九八|恐龙|福星|漂流|极速|刺客|七彩|音萌|恶灵|浴霸|PAR|CKP|OK|Youtube|大师|解啦|一零|六六|盘古|和巴|星驰|云端|奇米|片库|狼云|透明无接口)/i,
												/* 手机端强制屏蔽的接口 */ sjyyyzdypbobj =
												/(?:懒猫|木穆|巴陵|扫描|夜幕|七哥|虾米|百度|月亮|看剧|玻璃|海绵|我爱|神马|酷看|七彩|久播|恶灵|吉塔|盖斯|思[云念]|蘑菇|速云|迪奥|618G?|147|256|365|920|973|4080|黑云|九八|金桥|爱跟)/i; /* 手机端隐藏的接口 */
											for (let jxbqcsjjki = 0; jxbqcsjjki < jxbqcsjjk
												.length; jxbqcsjjki++) {
												if (localStorage.getItem("sjjkpbpbobj") == '1') {
													try {
														if (document.querySelector(
																"ul#httpsvipul>li:nth-child(" + localStorage
																.getItem('httpsjk') + ")").style.display ==
															'none') {
															jkpdobj();
														} else {}
													} catch (err) {}
													try {
														...
														if (document.querySelector(
																"ul#httpsvipul>li:nth-child(" + localStorage
																.getItem('httpsjk') + ")>span>a4").innerText
															.match(/(?:米侠|嗅探)/)) {
															jkpdobj();
														} else {}
													}
												} else {}
												const jxbqcsjjkmsa = jxbqcsjjk[jxbqcsjjki].querySelectorAll(
													'a1');
												for (let jxbqcsjjkia = 0; jxbqcsjjkia < jxbqcsjjkmsa
													.length; jxbqcsjjkia++) {
													if (!localStorage.getItem("sjqbjkobj") == '1') {
														if (!jxbqcsjjk[jxbqcsjjki].innerText.match(
																sjtzsjzdylwobj) && jxbqcsjjkmsa[jxbqcsjjkia]
															.innerText.match(
																/(?:搜索|跳转|[小大]窗|(?:小白)?自用|Json)/)) {
															jxbqcsjjk[jxbqcsjjki].setAttribute('style',
																'display:none!important')
														}
													} else {
														if (jxbqcsjjkmsa[jxbqcsjjkia].innerText.match(
																/(?:搜索|(?:小白)自用|Json)/i)) {
															jxbqcsjjk[jxbqcsjjki].setAttribute('style',
																'display:none!important');
														}
														if (!jxbqcsjjkmsa[jxbqcsjjkia].innerText.match(
																/(?:(?:[小大]窗)|跳转)/)) {
															const sjqbjka = jxbqcsjjk[jxbqcsjjki]
																.querySelectorAll('a4');
															if (objj.match(/acfun\./)) {
																for (let sjqbjkai = 0; sjqbjkai < sjqbjka
																	.length; sjqbjkai++) {
																	sjqbjka[sjqbjkai].innerText = sjqbjka[
																		sjqbjkai].innerText.replace(
																		/^(?!(?:(?:原|跳))?-|.*?嗅探)(.+?)$/,
																		"跳-$1");
																};
															} else {
														...
														if (jxbqcsjjkmsa[jxbqcsjjkia].innerText.match(
																/(?:(?:[小大]窗)|跳转|自用|Json)/i)) {
															const sjqbjkb = jxbqcsjjk[jxbqcsjjki]
																.querySelectorAll('a4');
															for (let sjqbjkbi = 0; sjqbjkbi < sjqbjkb
																.length; sjqbjkbi++) {
																sjqbjkb[sjqbjkbi].innerText = sjqbjkb[
																	sjqbjkbi].innerText.replace(
																	/^(?!(?:(?:原|跳))?-)(.+?)$/, "跳-$1");
															};
														}
													}
												...
												if (!localStorage.getItem("sjqbjkobj") == '1') {
													const jxbqcsjjkmsb = jxbqcsjjk[jxbqcsjjki]
														.querySelectorAll('a4');
													for (let jxbqcsjjkib = 0; jxbqcsjjkib < jxbqcsjjkmsb
														.length; jxbqcsjjkib++) {
														let jkmcobj = (jxbqcsjjkmsb[jxbqcsjjkib].innerText
															.match(sjqjpbzdylwobj)) || (jxbqcsjjkmsb[
															jxbqcsjjkib].innerText.match(
															sjyyyzdypbobj));
														let jkmclwobj = jxbqcsjjkmsb[jxbqcsjjkib].innerText
															.match(sjtzsjzdylwobj);
														if (jxbqcsjjkmsb[jxbqcsjjkib].innerText.match(
																/Parwix/i) && objj.match(
																/\.(?:bilibili|le)\./)) {
															jxbqcsjjk[jxbqcsjjki].setAttribute('style',
																'display:none!important')
														...
														if (objj.match(/acfun\./)) {
															if (!jkmcobj && !jxbqcsjjkmsb[jxbqcsjjkib]
																.innerText.match(/(?:米侠|嗅探)/) && !jkmclwobj
																) {
																jxbqcsjjkmsb[jxbqcsjjkib].innerText =
																	jxbqcsjjkmsb[jxbqcsjjkib].innerText
																	.replace(/^(?!(?:(?:原|跳))?-)(.+?)$/,
																		"跳-$1");
															}
														...
														if (jkmclwobj) {
															jxbqcsjjkmsb[jxbqcsjjkib].innerText =
																jxbqcsjjkmsb[jxbqcsjjkib].innerText.replace(
																	/^(?!(?:(?:原|跳))?-)(.+?)$/, "跳-$1");
														}
													}
												} else {
									...
									document.head.insertAdjacentHTML('beforeend',
										'<style>ul#httpsvipul *:active{color:chartreuse;background-color:black;}ul#httpsvipul .wsjxbshhjd{color:black;border:2.5px outset rgb(126,255,1);border-radius:5px;background-image:url(' +
										jxbtupiana +
									...
									(function() {
										let jxbewj = '',
											jxbwjstyle =
											'float:left;border-radius:3.5px;color:#000!important;box-shadow:inset rgba(255,254,255,.6) 0 0.3em 0.3em,inset rgba(0,0,0,.15) 0 -0.1em 0.3em,#d82661 0 0.1em 3px,#b7144a 0 0.3em 1px,rgba(0,0,0,.2) 0 0.5em 5px;background:0 0;font-weight:700;font-size:16px;padding:5px 2.5px 5px 2.5px;border:2.5px outset buttonface;text-decoration:none;background-color:#4CAF50;',
											jxbhttpsew = [{
												name: jxbewj + '<a style="' + jxbwjstyle +
													'" onclick="document.getElementById(\'jjxxkka\').style.display=\'none\';document.getElementById(\'jxbhttps\').click();" href="' +
													atob(
														"aHR0cHM6Ly9jZW8zMC5jb2RpbmcubmV0L3AvY2VvMzAvZC9jZW8zMC9naXQvcmF3L21hc3Rlci85NjM1NDA4MTctMS5wbmc="
														) + '" target="_blank">\u8d5e\u52a9</a>'
											}, {
												name: jxbewj + '<a style="' + jxbwjstyle +
													'" onclick="document.getElementById(\'jjxxkka\').style.display=\'none\';document.getElementById(\'jxbhttps\').click();" href="https://jq.qq.com/?_wv=1027&k=OvyfwB9X" target="_blank">\u52a0\u7fa4</a>'
											}, {
												name: jxbewj +
													'<span id="sjzdwsobj" onclick="document.getElementById(\'jjxxkka\').style.display=\'block\';document.getElementById(\'jxbewjul\').style.display=\'none\';document.getElementById(\'httpsvipul\').style.display=\'none\';" style="' +
													jxbwjstyle + '">\u641c\u7d22</span>'
											}, {
												name: jxbewj + '<span id="vipzdjxhy" style="' +
													jxbwjstyle + '">\u81ea\u52a8</span>'
											}, {
												name: jxbewj + '<span id="vipjxtbhy" style="' +
													jxbwjstyle +
													'" href="javascript:void(0);" onclick="localStorage.removeItem(\'httpsjk\');location.reload();">\u53cc\u51fb</span>'
											}, {
												name: jxbewj + '<span id="sjqbvipjk" style="' +
													jxbwjstyle +
													'" href="javascript:void(0);" onclick="localStorage.removeItem(\'sjqbjkobj\');location.reload();">\u5168\u90e8</span>'
											}, {
												name: jxbewj + '<span style="' + jxbwjstyle +
													'" href="javascript:void(0);" onclick="localStorage.clear();alert(\'当前网站 已经恢复 脚本默认设置\');location.reload();">\u91cd\u7f6e</span>'
											}];
										...
										function createSelectew(jxbhttpsew) {
											...
											jxbewjul.setAttribute("style",
												"display:none;margin:0;padding:0;position:fixed;bottom:150px;left:50%;transform:translateX(-50%);z-index:102030;overflow-x:auto;overflow-y:hidden;scrollbar-width:none;-webkit-overflow-scrolling:touch;white-space:nowrap;text-align:center;"
												);
											for (let i = 0; i < jxbhttpsew.length; i++) {
												let jxbewjli = document.createElement("li");
												jxbewjli.setAttribute("style",
													"margin:0;display:inline-block;height:40px;text-align:center;"
													);
												(function(jxbewj) {
										...
										function createMenuew() {
											...
											jxbewjBtn.onclick = function() {
												try {
													document.getElementById('jjxxkka').style.display =
														'none';
													document.getElementById('jjxxkkb').style.display =
														'none';
												} catch (err) {}
									...
									if (sjpdpthyobj == '1') {
										(function() {
											if (localStorage.getItem("vipzdjx") == '0') {
												...
												document.querySelector("#vipzdjxhy").style.backgroundColor =
													'#268dcd';
											...
											document.getElementById('vipzdjxhy').onclick = function() {
												if (this.innerHTML == '手动') {
													localStorage.setItem("vipzdjx", "2");
													this.innerText = '全部';
													document.querySelector("#vipzdjxhy").style
										...
										if (localStorage.getItem("vipjxtb") == '0') {
											...
											document.querySelector("#vipjxtbhy").style.backgroundColor =
												'#268dcd'
										...
										document.getElementById('vipjxtbhy').onclick = function() {
											if (this.innerHTML == '默认') {
												...
												this.innerText = '双击';
												document.querySelector("#vipjxtbhy").style
									...
									(function() {
										if (localStorage.getItem("sjqbjkobj") == '0') {
											...
											document.querySelector("#sjqbvipjk").style.backgroundColor =
												'#49a34c';
										...
										document.getElementById('sjqbvipjk').onclick = function() {
											if (this.innerHTML == '全部') {
												...
												this.innerText = '精简';
												document.querySelector("#sjqbvipjk").style
													.backgroundColor = '#268dcd';
												alert('已经显示 全部接口\n此模式 容易出现 接口广告\n请自行安装 广告过滤');
												dssxbobj();
								...
								setTimeout(() => {
									try {
										try {
											if (jxbpcobj) {} else {
												document.querySelector("ul#httpsvipul>li:nth-child(" +
														localStorage.getItem("httpsjk") + ")>span")
													.style.color = "black";
												document.querySelector("ul#httpsvipul>li:nth-child(" +
														localStorage.getItem("httpsjk") + ")>span")
													.style.border = "2.5px outset #7eff01";
												document.querySelector("ul#httpsvipul>li:nth-child(" +
														localStorage.getItem("httpsjk") + ")>span")
										...
										document.querySelector("ul#httpsvipul>li:nth-child(" +
												localStorage.getItem("httpsjk") + ")>span").style
											.backgroundImage = "url(" + jxbtupiana + ")";
									} catch (err) {}
												...
												if (this == a[j]) {
													try {
														if (jxbpcobj) {
															if (localStorage.getItem("pcjkzdyj") ==
																'1') {
																$('ul#httpsvipul>li>span').css(
																	"backgroundImage", "");
															} else {
																$('ul#httpsvipul>li>span:not([style*="AIH8BobyGoT"])')
																	.css("backgroundImage", "");
															}
														} else {
															$("ul#httpsvipul>li>span").css(
													...
													if ((localStorage.getItem("pcjkzdyj") == '1') ||
														...
														this.style.backgroundImage = "url(" +
															jxbtupiana + ")";
													} else if (localStorage.getItem("pcjkzdyj") ==
														'2') {
														this.style.backgroundImage = "url(" +
															jxbtupianb + ")";
													} else {
									...
									function sjssdqspobj(sjssdqsp) {
										...
										if (obj.match(/^https?:\/\/(?:3g|m)\.v\.qq\.com/)) {
											location.replace(sjssdqsp + document.querySelector(
												'section[dt-params*="标题"]').innerText);
										} else {
											let jxbzdws = document.title.replace(
													/(?:动[漫画]|电(?:视剧|影)|综艺)\s*?_/, "").replace(
													/^动态漫画\s*?[\W_]\s*?/, "").replace(
													/(?:会员|升级|加长)\w*?\s*?版/, "").replace(
													/（[^）]+?）\s*?第/, "第").replace(
													/^(\W+?)\s*?（[^\w）:：]+?）\s*?([：:].*)$/, "$1$2")
												.replace(
													/^([^：]+?)\s*?：(?:先导片|彩蛋|看点|花絮|预告|片花|神剧亮了)\s*?$/,
													"$1").replace(
													/^([^\\u4e00-\\u9fa5a-z]+?)\s*?\d+?.*?\1\s*?第.+?$/i,
													"$1").replace(
													/^(?:\s*?[\-\—\_<《\(（\[【]\s*?)?([^\s:：]+?)(?:\d{1,3}\s*?)?(?:\-|\—|\_|>|》|\)|）|:|：|\s+?).*?$/,
													...
													/^#([^\s]+?)\s*?\(\s*?[^\\u4e00-\\u9fa5a-z].*?$/i,
													"$1").replace(
													/^([^\\u4e00-\\u9fa5a-z\s:：\-]+?)[\[【\(（:：]?第?\s*?\d+?\s*?[部季集话部期].*?$/i,
													"$1").replace(
													/^([^\-\s]+?)(?:\(|第)\s*?.{1,3}[部季集话部期].*?$/, "$1")
												.replace(
													/^([^\\u4e00-\\u9fa5a-z]+?)(?:电视剧|剧集|电影|综艺|动漫)\W*?\s*?[\[【\(（].*?$/i,
													"$1").replace(/^([^\.\_\-]+?)\.[_\-].*?$/, "$1")
												.replace(/^([^:：\(]+?)。.*?$/, "$1").replace(
													/^([^\-\s]+?)—[^\\u4e00-\\u9fa5a-z]+?—.*?$/i, "$1")
												.replace(
									...
									let sjzdwsbtn = document.getElementById('sjzdws'),
										sjzdwssbtn = document.getElementById('sjzdwss'),
										sjzdwsssbtn = document.getElementById('sjzdwsss'),
										sjzdwssssbtn = document.getElementById('sjzdwssss'),
										sjchabeihubtn = document.getElementById('chabeihu');

									function sjzdwsbtnClick() {
										try {
											document.getElementById('jjxxkka').style.display = 'none';
										} catch (err) {}
										location.replace("https://www.ikukk.com/?url=" + window.location
											.href);
									};
									...
									function sjssd() {
										sjssdqspobj(
											'https://www.555dy6.com/vodsearch/-------------.html?wd='
											);
									};
									try {
						...
						function zdbt() {
							if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") != null) {
								...
								if (document.querySelector("\u6c5f\u5c0f\u767d\u6807\u9898") != null) {
									if (document.title.match(/^[^：]+?：\s*?第.+?[部季集话部期]\s*?(?:[上下]\s*?)?$/) !=
										null) {} else {
										let jxbzdws = document.title.replace(/(?:动[漫画]|电(?:视剧|影)|综艺)\s*?_/, "")
											.replace(/^动态漫画\s*?[\W_]\s*?/, "").replace(/(?:会员|升级|加长)\w*?\s*?版/, "")
											.replace(/（[^）]+?）\s*?第/, "第").replace(
												/^(\W+?)\s*?（[^\w）:：]+?）\s*?([：:].*)$/, "$1$2").replace(
												/^([^：]+?)\s*?：(?:先导片|彩蛋|看点|花絮|预告|片花|神剧亮了)\s*?$/, "$1").replace(
												/^([^\\u4e00-\\u9fa5a-z]+?)\s*?\d+?.*?\1\s*?第.+?$/i, "$1").replace(
												/^(?:\s*?[\-\—\_<《\(（\[【]\s*?)?([^\s:：]+?)(?:\d{1,3}\s*?)?(?:\-|\—|\_|>|》|\)|）|:|：|\s+?).*?$/,
												"$1").replace(/^#([^\s]+?)\s*?\(\s*?[^\\u4e00-\\u9fa5a-z].*?$/i,
												"$1").replace(
												/^([^\\u4e00-\\u9fa5a-z\s:：\-]+?)[\[【\(（:：]?第?\s*?\d+?\s*?[部季集话部期].*?$/i,
												"$1").replace(/^([^\-\s]+?)(?:\(|第)\s*?.{1,3}[部季集话部期].*?$/, "$1")
											.replace(
												/^([^\\u4e00-\\u9fa5a-z]+?)(?:电视剧|剧集|电影|综艺|动漫)\W*?\s*?[\[【\(（].*?$/i,
												"$1").replace(/^([^\.\_\-]+?)\.[_\-].*?$/, "$1").replace(
												/^([^:：\(]+?)。.*?$/, "$1").replace(
												/^([^\-\s]+?)—[^\\u4e00-\\u9fa5a-z]+?—.*?$/i, "$1").replace(
												/([^\\u4e00-\\u9fa5]+?)[a-zA-Z0-9]+?((?:\s+|$))/, "$1$2").replace(
												/^([^\(（]+?)[\(（].*$/, "$1").replace(
												/(^\w+?)\s*?[\s*?:/,"$1:").replace(/^[^《<]+?[《<]/, "");
										let jxbzdwsjs = document.title.replace(/\s+?/, "").replace(/会员\w+?版/, "")
											.replace(
												/^(?!.*?(?:(?:\s*?[\-\—\_<《\(（]\s*?)?[^\s:：]+?\d{1,3}?\s*?(?:\-|\—|\_|>|》|\)|）|:|：|\s+?)|\d+?\s*?集|(?:第\s*?.{1,3}|20\d{4,})\s*?[部季集话部期]|第\s*?\d{4}-\d{2}-\d{2}\s*?[部季集话部期]|先导片|彩蛋|看点|花絮|预告|片花|神剧亮了)).*?$/,
												"").replace(/^[^—_\-]+?(?!第)(\d+?集)[—_\-].+$/, "第$1").replace(
												/^(?!.+?(?:先导片|彩蛋|看点|花絮|预告|片花|神剧亮了|[部季集话部期]\s*?[上下]|第\s*?.{1,3}\s*?[部季].*?第\s*?\d{4}-\d{2}-\d{2}\s*?期)).*((?:(?:第\s*?.{1,3}|(?:第\s*?|\s+?)20\d{4,})\s*?(?<![\-_])[部季集话部期])).*?$/i,
												"$1").replace(
												/.+?(先导片|彩蛋|看点|花絮|预告|片花|神剧亮了|第\s*?.{1,3}\s*?[部季集话部期]\s*?[上下][部季集话部期]?).*?$/,
												"$1").replace(/^[^:：]+?(20\d{6})\s*?(期).*$/, "第$1$2").replace(
												/^(?!.+?(?:先导片|彩蛋|看点|花絮|预告|片花|神剧亮了|[部季集话部期]\s*?[上下])).+?(第)\s*?(\d{4})-(\d{2})-(\d{2})\s*?([期]).*?$/,
												"$1$2$3$4$5").replace(/^.+?[》>]\s*?20\d{2}-(\d{1,2})-(\d{1,2}期).*$/,
												"第$1$2").replace(/20\d{2}(\d{4}期)/, "$1");
						...
						function zddjjk() {
							...
							} else if (!document.querySelector('ul#httpsvipul>li:nth-child(' + httpsjk +
									')>span>a4').innerText.match(new RegExp("^\s*?跳\s*?-"))) {
								let jihao1 = 'ul#httpsvipul>li:nth-child(' + httpsjk + ')';
								let jihaoa = [jihao1];
								for (i = 0; i < jihaoa.length; i++) {
									if (exist(jihaoa[i]).style.display != "none") {
						...
						function zddj() {
							...
							if (vipzdjx == 1 || vipzdjx == 2 || vipjxss == 0) {
								if ((jxbpcobj && (vipzdjx == 2 || vipjxss == 0)) || !jxbpcobj && (vipzdjx == 1 ||
										vipzdjx == 2)) {
									zddjjk()
						...
						if (objj.match(/(?:bilibili|acfun|youku|qq|iqiyi|mgtv|sohu|le|pptv|ixigua)\./)) {
							if (gbdmobj == 1) {
								function tongyongdanmu() {
									cssobj(
										'[class*="danmu"],[id*="danmu"],[class*="danmaku"],[id*="danmaku"],[class*="barrage"],[id*="barrage"],[name*="danmuku"]');
								};
								if (obj.match(/^https?:\/\/www\.iqiyi\.com\/(?:[av]_|kszt\/)/)) {
									/* 关闭奇艺弹幕 */
									let iqiyidanmu =
										'div[class^="player-mnb-mid"],div[id^="player-mnb-mid"],div[class*="_voteEnter"],div[id*="_voteEnter"]';
									tongyongdanmu();
									cssobj(iqiyidanmu);
									remove(iqiyidanmu);
								} else if (obj.match(/^https?:\/\/www\.ixigua\.com\/\d{10,}/)) {
									/* 关闭西瓜弹幕 */
									let ixiguadanmu = '[class^="player"][class$="ExtraInfo"]';
									tongyongdanmu();
									cssobj(ixiguadanmu);
									remove(ixiguadanmu);
								} else if (obj.match(/^https?:\/\/tv\.sohu\.com\/v\//)) {
									...
									if (obj.match(/\/html5player\.html\?aid=/)) {
										...
										setTimeout(function() {
											jxbzdgbdmobj = setInterval(function() {
												if (document.querySelector(
														'[class*="player"][class*="-dm-wrap"]') !=
													null) {
													setTimeout(function() {
														try {
															if (document.querySelector(
																	'span[class="choose_danmaku"]'
																	) == null) {} else {
																(document.querySelector(
																	'span[class="choose_danmaku"]'
																	).innerText.match(
													...
													const scdmobj = document.querySelectorAll(
														'[class*="player"][class*="-dm-wrap"]');
													for (let scdmobji = 0; scdmobji < scdmobj
														.length; scdmobji++) {
														if (scdmobj[scdmobji]) {
									...
									(function() {
										...
										if (obj.match(
											...
											/^https?:\/\/v(?:-wb)?\.youku\.com\/v_show\/id_/)) {
						...
						try {
							if (mgzdgq == 1 || mgzdgq == 2 || vipzdjx == 1 || vipzdjx == 2 || localStorage.getItem(
									"zdpddy") == '1' || document.querySelector(
									"\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") && obj.match(
									/&autoplay=1&metareferer=/)) {
									...
									if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") !==
										...
										function jiangxiaobaiviphyzdpd() {
											if (obj.match(/&autoplay=1&metareferer=/)) {
												if (document.fullscreen) {} else if (document
													.fullscreenElement) {} else {
													if (document.querySelector(
														"\u6c5f\u5c0f\u767d\u5168\u5c4f")) {} else {
														try {
															window.scrollTo(0, document.documentElement
																.clientHeight);
														} catch (err) {}
														try {
															if (document.querySelector('video')) {
																try {
																	qpobj(document.querySelector('video').parentNode
																		.parentNode);
																} catch (err) {
																	qpobj(document.querySelector('video'));
																}
												...
												if (!document.querySelector(
													...
													if (document.querySelector(
															'iframe[src^="http"][src*="=http"][allowfullscreen]') !=
														null) {
														try {
															if (document.querySelector(
																	'iframe[src^="http"][src*="=http"][allowfullscreen]'
													...
													} else if (document.querySelector('[style*="eggvod"]') !=
														null) {
														try {
															document.querySelector('[style*="eggvod"]').parentNode
																.remove();
														} catch (err) {
															zdpddyobj();
														}
													} else if (document.querySelector(
															'[href^="javascript"][style*="data"][style*="image"]'
															) != null) {
														try {
															document.querySelector(
																	'[href^="javascript:"][style*="data:image/"]')
																.parentNode.remove();
														} catch (err) {
															zdpddyobj();
														}
													} else if (document.querySelector(
															'[href^="javascript"][target*="_blank"]') != null) {
														try {
															document.querySelector(
											...
											if (!document.querySelector('div#江小白') && document.querySelector(
													"jiangxiaobai") && !document.querySelector(
													"\u6c5f\u5c0f\u767d\u7535\u8111\u81ea\u52a8\u5224\u65ad") && ((
													mgzdgq == 1 || mgzdgq == 2 || vipzdjx == 1 || vipzdjx == 2))) {
												if ((mgzdgq == 1 || mgzdgq == 2 || vipzdjx == 2) && vipzdjx != 1) {
													try {
														if (obj.match(
																/^https?:\/\/v(?:-wb)?\.youku\.com\/v_show\/id_/)) {
															if ($("#toast_text:contains('试看')")[0] || $(
																	"#toast_text:contains('完整')")[0] || $(
																	"#toast_text:contains('购买')")[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-优酷会员自动解析-01-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($("#vip_limit_content:contains('试看')")[0] ||
																$("#vip_limit_content:contains('完整')")[0] || $(
																	"#vip_limit_content:contains('购买')")[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-优酷会员自动解析-02-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	".vip_player_payment_toast p:contains('试看')")[
																0] || $(
																	".vip_player_payment_toast p:contains('完整')")[
																0] || $(
																	".vip_player_payment_toast p:contains('购买')")[0]
																) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-优酷会员自动解析-03-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if (!document.querySelector(
																	"#ykPlayer>div.youku-film-player>video") && !
																document.querySelector("div.youku-layer-logo") &&
																document.querySelector(
																	'div.preplay-layer>img[src*=".ykimg.com/"][style^="display:"][style*="block"]'
																	)) {
																if ($(
																		"div.drm-error-layer div.note_normal_tit:contains('版权'):contains('加密'):contains('不支持')")[
																		0] && document.querySelector(
																		'div.preplay-layer>img[src*="/"]') && $(
																		"div.note_error_item_title:contains('换'):contains('浏览器')"
																		)[0]) {
																	dnzdpdobj();
																	zdztsp();
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%c江小白-电脑-优酷会员自动解析-04-工作中",
																		"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																		);
																} else {}
															} else {}
														} else if (obj.match(
																/^https?:\/\/[^\/]+?\.tudou\.com\/(?:v\/|.+?\/id_)/
																)) {
															if ($(
																	"div.information-tips:contains('看'):contains('会员')")[
																	0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-土豆会员自动解析-01-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	"div.vip_info:contains('看'):contains('会员')")[
																0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-土豆会员自动解析-02-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else {}
														} else if (obj.match(
																/^https?:\/\/v\.qq\.com\/(?:x\/cover|variety\/p\/topic)\//
																)) {
															if (localStorage.getItem("ymyypdobj") == '0') {
																if ((((!document.querySelector(
																			'[class*="item"][class$=" current"]:not([tabindex])[tl]'
																			) && document.querySelector(
																			'[class*="item"][class$=" current"]:not([tabindex]) i[class="mark_v"]>img[src*="_vip"]:not([alt])[src$=".png"]:not([src*="_trai"]):not([src*="_only"]):not([src*="_self"]):not([src*="_full"]):not([src*="_number"]):not([src*=".png/"])[srcset*="_vip"][srcset$=".png 2x"]:not([srcset*="_trai"]):not([srcset*="_only"]):not([srcset*="_self"]):not([srcset*="_full"]):not([srcset*="_number"]):not([srcset*=".png/"])'
																			)) || (document.querySelector(
																			'[class*="item"][class$=" current"]:not([tabindex])[tl] i[class="mark_v"]>img[src*="_vip"][alt][src$=".png"]:not([src*=".png/"])[srcset*="_vip"][srcset$=".png 2x"]:not([srcset*=".png/"])'
																			) && document.querySelector(
																			'[class*="item"][class$=" current"]:not([tabindex]) i[class="mark_v"]>img[src*="_vip"][src$=".png"]:not([src*="_trai"]):not([src*="_only"]):not([src*="_self"]):not([src*="_full"]):not([src*="_number"]):not([src*=".png/"])[srcset*="_vip"][srcset$=".png 2x"]:not([srcset*="_trai"]):not([srcset*="_only"]):not([srcset*="_self"]):not([srcset*="_full"]):not([srcset*="_number"]):not([srcset*=".png/"])'
																			)) || document.querySelector(
																			'[class*="item"][class$=" current"]:not([tabindex])[tl] i[class="mark_v"]>img[src*="_vip"]:not([alt])[src$=".png"]:not([src*="_trai"]):not([src*="_only"]):not([src*="_self"]):not([src*="_full"]):not([src*="_number"]):not([src*=".png/"])[srcset*="_vip"][srcset$=".png 2x"]:not([srcset*="_trai"]):not([srcset*="_only"]):not([srcset*="_self"]):not([srcset*="_full"]):not([srcset*="_number"]):not([srcset*=".png/"])'
																			)) && document.querySelector("video") !=
																		null) && !$(
																		"txpdiv.txp_ad_inner txpdiv.txp_ad_control txpdiv.txp_ad_skip_text:contains('关闭'):contains('广告')"
																		)[0]) {
															...
															if ($("txpdiv.txp_alert_info:contains('试看')")[0] && $(
																	"txpdiv.txp_alert_info txpdiv:contains('会员')")[
																	0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-腾讯会员自动解析-01-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	"div.wrapper.mod_vip_popup:contains('会员'):contains('看')"
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-腾讯会员自动解析-02-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if (!document.querySelector(
																	"#video_scroll_wrap div.mod_episode") && $(
																	"txpdiv.txp_ad_inner txpdiv.txp_ad_control txpdiv.txp_ad_skip_text:contains('关闭'):contains('广告')"
																	)[0] && $(
																	"#_vip_player_sec a:contains('会员'):contains('看')"
																	)[0]) {
																let qqggbtn = document.querySelector(
																	"txpdiv.txp_ad_inner txpdiv.txp_ad_control button"
																	);
																if (qqggbtn) {
																	qqggbtn.click();
																	qqggbtn.remove();
																...
																log("%c江小白-电脑-腾讯会员自动解析-03-工作中",
																	...
																	"#video_scroll_wrap div.mod_episode") || $(
																	"#video_scroll_wrap>div.mod_text_tabs>a.tab_item.current:contains('往期')"
																	)[0]) && $("#_vip_player_sec a:contains('会员')")[
																	0] && $("#_vip_player_sec a:contains('购买')")[
																0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-腾讯会员自动解析-04-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	'[data-role*="ui-error"]:contains("版权"):contains("加密"):contains("不支持"):contains("播放")'
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-腾讯会员自动解析-05-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	".content h1:contains('会员'):contains('超前'):contains('点播')"
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-腾讯会员自动解析-06-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	'txpdiv[data-role*="tips"][data-role*="text"]:contains("试看"):contains("分钟")'
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-腾讯会员自动解析-07-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	'[data-role*="txp-ui-tips"]:contains("版权"):contains("购买")'
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-腾讯会员自动解析-08-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	'[data-role^="txp-ui-tips"]:contains("会员"):contains("看")'
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-腾讯会员自动解析-09-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else {}
														} else if (obj.match(
																/^https?:\/\/(?:ww)?w\.mgtv\.com\/[a-z]\//)) {
															try {
																if ((mgzdgq == 1 || mgzdgq == 2) && document
																	.querySelector(
																		".m-player-h5-new .u-control-clarity .btn"
																		) && document.querySelector(
																		".m-player-h5-new .u-control-clarity .btn")
																	.innerText.match(/^\s*?自动/) && vipzdjx != 1 && !
																	document.querySelector(
																		"\u6211\u662f\u7535\u8111\u8292\u679c")) {
																	if (mgzdgq == 1) {
																		if (document.querySelector(
																				'a[data-name="超清"][data-purview="true"]'
																				)) {
																			dnmgqxdpdobj();
																			document.querySelector(
																				'a[data-name="超清"][data-purview="true"]'
																				).click();
																			log("%c江小白-电脑-芒果自动选择超清-01-工作中",
																				"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																				);
																		} else if (document.querySelector(
																				'a[data-name="高清"][data-purview="true"]'
																				)) {
																			dnmgqxdpdobj();
																			document.querySelector(
																				'a[data-name="高清"][data-purview="true"]'
																				).click();
																			log("%c江小白-电脑-芒果自动选择高清-02-工作中",
																				"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																				);
																		} else {}
																	} else if (mgzdgq == 2) {
															...
															if (vipzdjx == 2 && obj.match(
																	/^https?:\/\/(?:ww)?w\.mgtv\.com\/b\//)) {
																if ($(
																		"div.control-tips-line>p:contains('费'):contains('看')")[
																		0]) {
																	dnzdpdobj();
																	zdztsp();
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%c江小白-电脑-芒果TV会员自动解析-01-工作中",
																		"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																		);
																} else if ($(
																		"mango-center-state>mango-center-state-error h2:contains('版权'):contains('限制')"
																		)[0] && $(
																		"mango-center-state>mango-center-state-error p:contains('扫码'):contains('看')"
																		)[0]) {
																	dnzdpdobj();
																	zdztsp();
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%c江小白-电脑-芒果TV会员自动解析-02-工作中",
																		"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																		);
																} else if ($(
																		"mango-center-state div.m-player-paytips-title:contains('费'):contains('看')"
																		)[0] && $(
																		"mango-center-state div.m-player-paytips-buttons.onerow a:contains('费'):contains('看')"
																		)[0]) {
																	dnzdpdobj();
																	zdztsp();
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%c江小白-电脑-芒果TV会员自动解析-03-工作中",
																		"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																		);
																} else if ($(
																		"mango-control-tip p:contains('看'):contains('分钟')"
																		)[0]) {
																	dnzdpdobj();
																	zdztsp();
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%c江小白-电脑-芒果TV会员自动解析-04-工作中",
																		"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																		);
																} else if ($(
																		".m-player-paytips-wrapper div.m-player-paytips-title:contains('会员'):contains('看')"
																		)[0]) {
																	dnzdpdobj();
																	zdztsp();
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%c江小白-电脑-芒果TV会员自动解析-05-工作中",
																		"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																		);
																} else if ($(
																		"mango-center-state-payment:contains('购买')"
																		)[0]) {
																	dnzdpdobj();
																	zdztsp();
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%c江小白-电脑-芒果TV会员自动解析-06-工作中",
																		"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																		);
																} else if ($("mango-control-tip:contains('完整')")[
																	0]) {
																	dnzdpdobj();
																	zdztsp();
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%c江小白-电脑-芒果TV会员自动解析-07-工作中",
																		"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																		);
																} else {}
															} else {}
														} else if (obj.match(
																/^https?:\/\/www\.iqiyi\.com\/(?:[av]_|kszt\/)/)) {
															if (localStorage.getItem("ymyypdobj") == '0') {
																if ((document.querySelector(
																		'ul>li[class*="item"][class$=" selected"] img[src*="/vip"][src$=".png"]:not([src*=".png/"])[srcset*="/vip"][srcset*=".png"]:not([srcset*=".png/"])'
																		) || document.querySelector(
																		'ul>li[class*="item"][class$=" selected"] img[src*="/VIP"][src$=".png"]:not([src*=".png/"])[srcset*="/VIP"][srcset*=".png"]:not([srcset*=".png/"])'
																		)) && document.querySelector(
																		'[tabindex="-1"][data-player-hook]>video[src^="blob:http"]'
																		)) {
																	dnzdpdobj();
																	setTimeout(function() {
																		zdztsp();
																		...
																		'i+a[class="logo-channel"] h1').innerText
																	.match(/^\s*?动漫\s*?$/)) {
																	dnzdpdobj();
																	setTimeout(function() {
																		zdztsp();
																		...
																		'iqpdiv[class="iqp-layer-main"]:contains("播放"):contains("失败")'
																		)[0]) {
																	dnzdpdobj();
																	zdztsp();
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%c江小白-电脑-爱奇艺会员自动解析-00-c-工作中",
																		"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																		);
																} else {}
															} else {}
															if (document.querySelector(
																	"#flashbox>iqpdiv iqpdiv.iqp-bottom iqpspan") &&
																document.querySelector(
																	"#flashbox>iqpdiv iqpdiv.iqp-bottom iqpspan>i"
																	) && document.querySelector(
																	"#flashbox>iqpdiv iqpdiv.iqp-bottom iqpspan>i+a"
																	)) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-爱奇艺会员自动解析-01-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if (document.querySelector(
																	"#flashbox>iqpdiv iqpdiv.iqp-layer.iqp-layer-error>iqpdiv"
																	) && document.querySelector(
																	"#flashbox>iqpdiv iqpdiv.iqp-layer.iqp-layer-error>iqpdiv>a"
																	) && document.querySelector(
																	"#rightPlayList>div.side-content>article a")) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-爱奇艺会员自动解析-02-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if (document.querySelector(
																	"div.qy-player-vippay-popup div.popup-main>p"
																	) && document.querySelector(
																	"div.qy-player-vippay-popup a.vippay-btn")) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-爱奇艺会员自动解析-03-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($("iqpspan:contains('试看')")[0] || $(
																	"iqpspan:contains('完整')")[0] || $(
																	"iqpspan:contains('开通')")[0] || $(
																	"iqpspan:contains('购买')")[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-爱奇艺会员自动解析-04-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	'[class^="vippay"][class*="-popup"] p:contains("点播")'
																	)[0] || $(
																	'[class^="vippay"][class*="-popup"] p:contains("付费")'
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-爱奇艺会员自动解析-05-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if (!($(
																	'[class^="vippay"][class*="-popup"] p:contains("专享"):contains("互动")'
																	)[0]) && ($(
																	'[class^="vippay"][class*="-popup"] p:contains("会员"):contains("专享")'
																	)[0])) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-爱奇艺会员自动解析-06-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	'[class^="vippay"][class*="-popup"] a:contains("费")a:contains("看")'
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-爱奇艺会员自动解析-07-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else {}
														} else if (obj.match(/^https?:\/\/tv\.sohu\.com\/v\//)) {
															if (!$("#player_vipTips:contains('以上画质')")[0] && $(
																	"#player_vipTips p:contains('会员'):contains('看')"
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-搜狐电视会员自动解析-01-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else {}
														} else if (obj.match(
															/^https?:\/\/film\.sohu\.com\/album\//)) {
															if ($(
																	"div.x-dash-tip-panel>span:contains('看'):contains('分钟')")[
																	0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-搜狐电影会员自动解析-01-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	'[class="x-tip-btn x-tip-vip"]:contains("购买")')[
																	0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-搜狐电影会员自动解析-02-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else {}
														} else if (obj.match(
																/^https?:\/\/www\.le\.com\/ptv\/vplay\//)) {
															if ($(
																	"div.playbox_vip_tip_bg.j-vipTip:contains('会员'):contains('看')")[
																	0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-乐视会员自动解析-01-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	"div.hv_tip1.js-tip:contains('看'):contains('会员')"
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-乐视会员自动解析-02-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else {}
														} else if (obj.match(/^https?:\/\/v\.pptv\.com\/show\//)) {
															if ($(
																	'[class*="tips-content"]:contains("费"):contains("看")')[
																	0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-PPTV会员自动解析-01-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	'[class*="buyGuidance"]:contains("费"):contains("看")'
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-PPTV会员自动解析-02-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else {}
														} else if (obj.match(
															/^https?:\/\/vip\.1905\.com\/play\//)) {
															if ($(
																	"div.sb-toggle-card.card-pay.card-active:contains('费')")[
																	0] && $(
																	"div.pay-mod-notlogin>div.notlogin-login:contains('会员'):contains('看')"
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-1905会员自动解析-01-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if (document.querySelector("#pDialog") && $(
																	"div.sb-toggle-card.card-pay.card-active:contains('费')"
																	)[0] && $(
																	"#pSidebar>div.sb-content>div.sb-mod-pay p:contains('版权'):contains('二维码'):contains('下载'):contains('看')"
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-1905会员自动解析-02-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if (!document.querySelector(
																	"div.sc-content.clearfix.hidden") && $(
																	"div.clearfix.rightCon_player>div.style_one.clearfix>p>a:contains('开通'):contains('会员')"
																	)[0] && $(
																	"div.sc-content.clearfix:contains('看'):contains('会员'):contains('完整')"
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-1905会员自动解析-03-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else {}
														} else if (obj.match(
																/^https?:\/\/www\.wasu\.cn\/.+?\/show\/id\//)) {
															if ($(
																	"#flashContent ws-tipinfo:contains('费'):contains('看')")[
																	0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-华数TV会员自动解析-01-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else {}
														} else if (obj.match(
															...
															if ($(
																	"#player_mask_module div.twp-title:contains('会员'):contains('看')")[
																	0] && $(
																	"#player_mask_module div.twp-btns:contains('会员')"
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-哔哩哔哩会员自动解析-01-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	".bilibili-player-video-toast-item .video-float-hint-text:contains('会员'):contains('看')"
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-哔哩哔哩会员自动解析-02-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																".mask-info:contains('地区'):contains('无法')")[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-哔哩哔哩会员自动解析-03-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-哔哩哔哩会员自动解析-04-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else if ($(
																	'span[class*="player-toast-text"]:contains("试看")'
																	)[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-哔哩哔哩会员自动解析-05-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else {}
														} else if (obj.match(
															...
															if (document.querySelector(
																	'li[class="single-p active"][data-href] span')
																.innerText.match(/^\s*?(?:vip|付费|抢鲜)\s*?$/i)) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-AcFun会员自动解析-01-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else {}
														} else if (obj.match(
																/https?:\/\/www\.ixigua\.com\/\d{10,}\?id=/)) {
															if ($('[class$="__gold"]:contains("完整")')[0] && document
																.querySelector("div.payBtn")) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%c江小白-电脑-西瓜视频会员自动解析-01-工作中",
																	"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																	);
															} else {}
														} else {}
										...
										function jiangxiaobaiviphyzdpd(ele) {
											if (!document.querySelector(
												...
												if (document.querySelector(
													...
													try {
														document.querySelector(
															'[href^="javascript"][target*="_blank"]').remove();
													} catch (err) {
														zdpddyobj();
													}
												} else {}
												...
												if (vipzdjx == 1) {
													if (obj.match(/^https?:\/\/m\.mgtv\.com\/b\//)) {
														if ($('[class*="box"]:contains("费"):contains("看")')[0]) {
															...
															document.querySelector("jiangxiaobai").remove();
															zddjobj();
															log("%c江小白-手机-芒果TV会员自动解析-01-工作中",
																"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																);
														} else if ($(
																'[class*="error"]:contains("版权"):contains("限制")')[
															0]) {
															sjzdpdobj();
															document.querySelector("jiangxiaobai").remove();
															zddjobj();
															log("%c江小白-手机-芒果TV会员自动解析-02-工作中",
																"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																);
														} else {}
													} else if (obj.match(/^https?:\/\/m\.pptv\.com\/show\//)) {
														if ($('[class*="tip"]:contains("看"):contains("费")')[0]) {
															...
															document.querySelector("jiangxiaobai").remove();
															zddjobj();
															log("%c江小白-手机-PPTV会员自动解析-01-工作中",
																"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																);
														} else if ($(
																'[class*="info"]>[class*="title"] i[class*="icon"]:contains("VIP")'
																)[0] && $(
																'[id*="play-complete-"]:contains("看"):contains("完整")'
																)[0]) {
															sjzdpdobj();
															document.querySelector("jiangxiaobai").remove();
															zddjobj();
															log("%c江小白-手机-PPTV会员自动解析-02-工作中",
																"border-left:5px solid #03A9F4;color:#03A9F4;padding:3px"
																);
														} else {}
													} else if (obj.match(
								...
								try {
									if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") && obj
										...
										pczdjxycobj = setInterval(function() {
											if (document.querySelector(
													"\u6211\u662f\u6c5f\u5c0f\u767d\u751f\u6d3b\u5f88\u7b80\u5355"
													) && document.querySelector("div#jxbhttps")) {
												panduanshebeiobj();
										...
										function sjjxbvipzcjxobj() {
											if (document.querySelector(
												"\u6c5f\u5c0f\u767d\u624b\u673a\u7f51\u9875") && (vipzdjx == 1 ||
													vipzdjx == 2)) {
												if (obj.match(
														/^https?:\/\/(?:3g|m)\.v\.qq\.com\/.*?(?:[cv]id=|cover\/)/
														)) {
													if (document.querySelector("div#江小白") == null) {
														try {
															document.querySelector("jiangxiaobai").remove();
						...
						document.onreadystatechange = function() {
							"complete" == document.readyState && setTimeout(function() {
								if (window.location.href.match(
										/^https?:\/\/(?:v(?:-wb)?\.youku\.com\/v_show\/id_|m\.youku\.com\/.+?\/id_|[^\/]+?\.tudou\.com\/(?:v\/|.+?\/id_)|v\.qq\.com\/(?:x\/cover|variety\/p\/topic)\/|(?:3g|m)\.v\.qq\.com\/.*?(?:[cv]id=|cover\/)|w(?:ww)?\.mgtv\.com\/(?:b|act)\/|m\.mgtv\.com\/b\/|www\.iqiyi\.com\/(?:[awv]_|kszt\/)|tw\.iqiyi\.com\/v_|m\.iqiyi\.com\/v_|tv\.sohu\.com\/v\/|film\.sohu\.com\/album\/|m\.tv\.sohu\.com\/(?:v|phone_play_film\?aid=)|www\.le\.com\/ptv\/vplay\/|m\.le\.com\/vplay_|v\.pptv\.com\/show\/|m\.pptv\.com\/show\/|vip\.1905\.com\/play\/|www\.wasu\.cn\/.+?\/show\/id\/|www\.bilibili\.com\/bangumi\/play\/|m\.bilibili\.com\/bangumi\/play\/|www\.acfun\.cn\/bangumi\/|m\.acfun\.cn\/v\/|www\.fun\.tv\/vplay\/g-|www\.ixigua\.com\/\d{10,})/
										) && !(window.location.href.match(
											/^https?:\/\/(?:www|m)\.iqiyi\.com\/(?:a_|kszt\/)/) &&
										document.title.match(new RegExp("在线观看"))) && !(window.location
										.href.match(/^https?:\/\/(?:www|m)\.iqiyi\.com\/v_/) && document
										.title.match(new RegExp("名师课堂")))) {
								...
								if (lkzdzt == 1) {
									(function() {
										try {
											...
											document.addEventListener('visibilitychange',
										function() {
												let videoaobj = document.querySelector(
														"video"),
													videobobj = document.querySelector(
														'div#江小白');
												if (document.hidden && videoaobj && !
													videobobj) {
													videoaobj.pause();
													document.title = '自动暂停';
													clearTimeout(titleTime);
								...
								if (jxbpcobj && vipjxss == 1 && !ttbkjjliobj && !objj.match(
										/(?:pan|yun)\.baidu/)) {
									(function() {
										try {
											let jxbzdwss = document.title.replace(
													/(?:动[漫画]|电(?:视剧|影)|综艺)\s*?_/, "").replace(
													/^动态漫画\s*?[\W_]\s*?/, "").replace(
													/(?:会员|升级|加长)\w*?\s*?版/, "").replace(
													/（[^）]+?）\s*?第/, "第").replace(
										...
										(function() {
											if (localStorage.getItem("lkzdzt") == '0') {
												document.getElementById('lkzdztby').innerText =
													'暂停默认';
												document.querySelector("#lkzdztby").style
													.backgroundColor = '#268dcd';
											...
											document.getElementById('lkzdztby').onclick =
												function() {
													if (this.innerHTML == '暂停默认') {
														localStorage.setItem("lkzdzt", "1");
														this.innerText = '自动暂停';
														document.querySelector("#lkzdztby")
															.style.backgroundColor = '#005200';
										...
										(function() {
											if (localStorage.getItem("jxzdqp") == '0') {
												document.getElementById('pcjxzdqp').innerText =
													'全屏默认';
												document.querySelector("#pcjxzdqp").style
													.backgroundColor = '#268dcd';
											...
											document.getElementById('pcjxzdqp').onclick =
												function() {
													if (this.innerHTML == '全屏默认') {
														localStorage.setItem("jxzdqp", "1");
														this.innerText = '解析全屏';
														document.querySelector("#pcjxzdqp")
															.style.backgroundColor = '#005200';
										...
										(function() {
											if (localStorage.getItem("mgzdgq") == '0') {
												document.getElementById('mgzdgq').innerText =
													'默认画质';
												document.querySelector("#mgzdgq").style
													.backgroundColor = '#268dcd'
											...
											document.getElementById('mgzdgq').onclick =
												function() {
										...
										(function() {
											if (localStorage.getItem("vipzdjx") == '0') {
												document.getElementById('vipzdjx').innerText =
													'手动解析';
												document.querySelector("#vipzdjx").style
													.backgroundColor = '#268dcd';
											} else if (localStorage.getItem("vipzdjx") == '1') {
												document.getElementById('vipzdjx').innerText =
													'解析全部';
											...
											document.getElementById('vipzdjx').onclick =
												function() {
										...
										(function() {
											...
											document.getElementById('vipzdjxhy').onclick =
												function() {
													if (this.innerHTML == '手动解析') {
														localStorage.setItem("vipzdjx", "2");
														this.innerText = '解析会员';
														document.querySelector("#vipzdjxhy")
										...
										(function() {
											if (localStorage.getItem("pcjkzdyj") == '0') {
												document.getElementById('pcjkzdyj').innerText =
													'关闭记忆';
												document.querySelector("#pcjkzdyj").style
													.backgroundColor = '#268dcd'
											} else if (localStorage.getItem("pcjkzdyj") ==
												'1') {
												document.getElementById('pcjkzdyj').innerText =
											...
											document.getElementById('pcjkzdyj').onclick =
												function() {
													if (this.innerHTML == '关闭记忆') {
														localStorage.setItem("pcjkzdyj", "1");
														this.innerText = '自动记忆';
														document.querySelector("#pcjkzdyj")
															.style.backgroundColor = '#005200';
										...
										(function() {
											if (localStorage.getItem("ymyypdobj") == '0') {
												document.getElementById('ymyypdobj').innerText =
													'没有会员';
												document.querySelector("#ymyypdobj").style
													.backgroundColor = '#268dcd'
											} else if (localStorage.getItem("ymyypdobj") ==
												'1') {
												document.getElementById('ymyypdobj').innerText =
													'已有会员';
												document.querySelector("#ymyypdobj").style
											...
											document.getElementById('ymyypdobj').onclick =
												function() {
													if (this.innerHTML == '已有会员') {
														localStorage.setItem("ymyypdobj", "0");
														this.innerText = '没有会员';
														document.querySelector("#ymyypdobj")
															.style.backgroundColor = '#005200';
														dssxbobj()
										...
										(function() {
											if (localStorage.getItem("gbkjjjobj") == '0') {
												document.getElementById('gbkjjjobj').innerText =
													'关闭快捷';
												document.querySelector("#gbkjjjobj").style
													.backgroundColor = '#268dcd'
											} else if (localStorage.getItem("gbkjjjobj") ==
												'1') {
												document.getElementById('gbkjjjobj').innerText =
													'开启快捷';
												document.querySelector("#gbkjjjobj").style
											...
											document.getElementById('gbkjjjobj').onclick =
												function() {
													if (this.innerHTML == '开启快捷') {
														localStorage.setItem("gbkjjjobj", "0");
														this.innerText = '关闭快捷';
														document.querySelector("#gbkjjjobj")
															.style.backgroundColor = '#005200';
										...
										(function() {
											if (localStorage.getItem("gbdmobj") == '0') {
												document.getElementById('gbdmobj').innerText =
													'默认弹幕';
												document.querySelector("#gbdmobj").style
													.backgroundColor = '#268dcd'
											...
											document.getElementById('gbdmobj').onclick =
												function() {
										...
										(function() {
											function vipjxtbxs() {
												document.head.insertAdjacentHTML("beforeend",
													'<style class="viptb-jiangxiaobai" media="screen">div#jxbhttps,div.maomibtn{opacity:1}</style>'
													);
											};

											function vipjxtbgb() {
												document.head.insertAdjacentHTML("beforeend",
													'<style class="viptb-jiangxiaobai" media="screen">div#jxbhttps,div.maomibtn{opacity:0}div#jxbhttps:hover,div.maomibtn:hover{opacity:1}</style>'
													);
											};

											function vipjxtbzs() {
												document.head.insertAdjacentHTML("beforeend",
													'<style class="viptb-jiangxiaobai" media="screen">div#jxbhttps{opacity:1}div.maomibtn{opacity:0}div.maomibtn:hover{opacity:1}</style>'
													)
											};
											if (localStorage.getItem("vipjxtb") == '0') {
												document.getElementById('vipjxtb').innerText =
													'关闭图标';
												document.querySelector("#vipjxtb").style
													.backgroundColor = '#268dcd'
											...
											document.getElementById('vipjxtb').onclick =
												function() {
													if (pcliwaiobj || ttblwobj) {
														if (this.innerHTML == '关闭图标') {
															if (pcliwaiobj) {
																localStorage.setItem("vipjxtb",
																	"2");
																this.innerText = '只显钻石';
																document.querySelector(
																		"#vipjxtb").style
															...
															"1");
															this.innerText = '显示图标';
															document.querySelector("#vipjxtb")
						...
						if (vipjxtb == 0) {
							try {
								function viptbjiangxiaobaia() {
									document.head.insertAdjacentHTML("beforeend",
										'<style class="viptb-jiangxiaobaia" media="screen">div#jxbhttps,div.maomibtn{opacity:0}div#jxbhttps:hover,div.maomibtn:hover{opacity:1}</style>'
										)
								};
								try {
									viptbjiangxiaobaia()
							...
							try {
								function viptbjiangxiaobaib() {
									document.head.insertAdjacentHTML("beforeend",
										'<style class="viptb-jiangxiaobaib" media="screen">div.maomibtn{opacity:0}div.maomibtn:hover{opacity:1}</style>'
										)
								};
								try {
									viptbjiangxiaobaib()
						...
						try {
							if (kjjlwobj && localStorage.getItem("gbkjjjobj") != '1') {
								if (jxbpcobj && (pcliwaiobj || ttbkjjliobj || mmkjjtjobj || obj.match(
										/^https?:\/\/(?:www\.bilibili\.com\/(?!bangumi\/play\/)|www\.acfun\.cn\/(?!bangumi\/))/
										))) {
									try {
										function ywyjklb() {
											if (pcliwaiobj) {
										...
										function zdssspa() {
											if (pcliwaiobj) {
												...
												(function() {
													try {
														window.open(document.querySelector(
															'div.maomibtn>ul>li>ul>li>a[href*="//www.bumimi"]'
															).href, "bkmk_popup");
													} catch (err) {
														return false;
										...
										function jxywyfsgba() {
											if (pcliwaiobj && !objj.match('(?:acfun|ixigua)')) {
												(function() {
													try {
														if (localStorage.getItem("jxywyfsgbobj") != null && !(
																localStorage.getItem("jxywyfsgbobj") == '2' ||
																localStorage.getItem("jxywyfsgbobj") == '3')) {
										...
										function jxywyfsgbb() {
											if (pcliwaiobj && !objj.match('(?:acfun|ixigua)')) {
												(function() {
													try {
														if (localStorage.getItem("jxywyfsgbobj") != null && !(
																localStorage.getItem("jxywyfsgbobj") == '1' ||
																localStorage.getItem("jxywyfsgbobj") == '3')) {
															localStorage.removeItem('jxywyfsgbobj');
															alert('现在已经恢复 原网页解析 方式');
														} else {
										...
										function jxywyfsgbd() {
											if (pcliwaiobj && !objj.match('(?:acfun|ixigua)')) {
												(function() {
													try {
														if (localStorage.getItem("jxcxkfsgbobj") != null && !(
																localStorage.getItem("jxcxkfsgbobj") == '2')) {
										...
										function jxywyfsgbe() {
											if (pcliwaiobj && !objj.match('(?:acfun|ixigua)')) {
												(function() {
													try {
														if (localStorage.getItem("jxcxkfsgbobj") != null && !(
																localStorage.getItem("jxcxkfsgbobj") == '1')) {
															localStorage.removeItem('jxcxkfsgbobj');
															alert('现在已经恢复 小窗口解析 方式');
														} else {
										...
										function tbxsyca() {
											if (!ttbkjjliobj) {
												(function() {
													try {
														document.querySelector(
															"div.maomibtn li#vipjxtbli>a#vipjxtb").click();
													} catch (err) {
														return false;
													}
												})();
										...
										function ckjxbkjj() {
											if ((!ttbkjjliobj || objj.match('(?:bilibili|acfun)'))) {
												(function() {
													try {
														document.querySelector("div.maomibtn li>a#jxbkjj")
															.click();
													} catch (err) {
														return false;
													}
										...
										function tbxsycb() {
											if ((!ttbkjjliobj || objj.match('(?:bilibili|acfun)'))) {
												(function() {
													try {
														document.querySelector(
															"div.maomibtn li#lkzdztbyli>a#lkzdztby").click();
														location.reload();
													} catch (err) {
														return false;
													}
											...
											if ((!ttbkjjliobj || objj.match('(?:bilibili|acfun)'))) {
												(function() {
													try {
														...
														document.querySelector(
															"div.maomibtn li#gbdmobjli>a#gbdmobj").click();
														location.reload();
													} catch (err) {
														return false;
													}
										...
										function sddja() {
											if (pcliwaiobj || ttbkjjliobj) {
												if (pcliwaiobj) {
													(function() {
														try {
															if (document.querySelector("iframe#江小白") && !objj
																.match('ixigua\.')) {
																try {
																	if (!document.querySelector("img#江小白")) {
																		try {
																...
																$(function() {
																	...
																	var qjsdjk_jiankong = setInterval(
																		function() {
																			var qjsdjk_btn = $(
																				"ul#httpsvipul>li"
																				);
																			if (qjsdjk_btn) {
																				...
																				if (!document
																					...
																					(function() {
																						try {
																							let sdjxyywzdqp_counter =
																								0;
																							let sdjxyywzdqp_jiankong =
																								setInterval(
																									function() {
																										let sdjxyywzdqp_btn =
																											document
																										...
																										if (
																											...
																											clearInterval
																												(
																													sdjxyywzdqp_jiankong);
																											return false
																										}++
																										sdjxyywzdqp_counter
																										;
																										if (sdjxyywzdqp_counter >
																											5
																											) {
																											clearInterval
																												(
											...
											if (pcliwaiobj && !objj.match('ixigua\.')) {
												try {
													...
													if (arrb.length == '0') {
														(function() {
															try {
																const nullsjjkslobjb = document
																	.querySelectorAll("#httpsvipul>li");
																let nullarrb = [],
																	nullarrbhttpsjk;
																for (let nullsjjkslobjbi = 0; nullsjjkslobjbi <
																	nullsjjkslobjb.length; nullsjjkslobjbi++) {
																	if ((nullsjjkslobjb[nullsjjkslobjbi].style
																			.display != 'none') && (
																			nullsjjkslobjb[nullsjjkslobjbi]
																			.querySelector('a1').innerText
																			.match(/^\s*?[小大]窗\s*?$/))) {
																		nullarrb.push(nullsjjkslobjb[
																				nullsjjkslobjbi]
																			.querySelector('a2').innerText)
																	}
																};
																nullarrbhttpsjk = nullarrb[Math.floor((Math
																	.random() * nullarrb.length))];
																document.querySelector(
																	"ul#httpsvipul>li:nth-child(" +
																	nullarrbhttpsjk + ")").click();
																sessionStorage.setItem('nullarrbhttpsjk',
																	nullarrbhttpsjk);
																if (localStorage.getItem("pcjkzdyj") == '1') {
																	$('ul#httpsvipul>li>span').css(
																		"backgroundImage", "");
																	try {
																		if (document.querySelector(
																				"ul#httpsvipul>li>span.wsjxbshhjd"
																				)) {
																			document.querySelector(
																					"ul#httpsvipul>li>span.wsjxbshhjd"
																...
																if (localStorage.getItem("pcjkzdyj") == '1') {
																	document.querySelector(
																			"ul#httpsvipul>li:nth-child(" +
																			arrbhttpsjk + ")>span").style
																		.backgroundImage = "url(" + jxbtupiana +
																		")";
																	localStorage.setItem('httpsjk',
																	arrbhttpsjk);
																} else if (localStorage.getItem("pcjkzdyj") ==
																	'2') {
																	document.querySelector(
																			"ul#httpsvipul>li:nth-child(" +
																			arrbhttpsjk + ")>span").style
																		.backgroundImage = "url(" + jxbtupianb +
																		")";
																	localStorage.setItem('httpsjk',
																	arrbhttpsjk);
																} else {
																	document.querySelector(
																			"ul#httpsvipul>li:nth-child(" +
																			arrbhttpsjk + ")>span").style
																		.backgroundImage = "url(" + jxbtupianc +
																		")";
																}
															} catch (err) {
																return false
														...
														try {
															if (sessionStorage.getItem("nullarrbhttpsjk") ==
																null) {} else {
																arrb.removeByValue(sessionStorage.getItem(
																	"nullarrbhttpsjk"));
																sessionStorage.removeItem("nullarrbhttpsjk");
															}
														} catch (err) {}
														arrbhttpsjk = arrb[Math.floor((Math.random() * arrb
															.length))];
														document.querySelector("ul#httpsvipul>li:nth-child(" +
															arrbhttpsjk + ")").click();
														if (localStorage.getItem("pcjkzdyj") == '1') {
															...
															try {
																if (document.querySelector(
																		"ul#httpsvipul>li>span.wsjxbshhjd").style
																	.backgroundImage.match(/AIH8BobyGoT/)) {
																	document.querySelector(
																			"ul#httpsvipul>li>span.wsjxbshhjd")
																		.style.backgroundImage = 'none'
																} else {}
														...
														if (localStorage.getItem("pcjkzdyj") == '1') {
															document.querySelector("ul#httpsvipul>li:nth-child(" +
																	arrbhttpsjk + ")>span").style.backgroundImage =
																"url(" + jxbtupiana + ")";
											...
											if (pcliwaiobj && !objj.match('ixigua\.')) {
												try {
													...
													if (arra.length == '0') {
														(function() {
															try {
																const nullsjjkslobja = document
																	.querySelectorAll("#httpsvipul>li");
																let nullarra = [],
																	nullarrahttpsjk;
																for (let nullsjjkslobjai = 0; nullsjjkslobjai <
																	nullsjjkslobja.length; nullsjjkslobjai++) {
																	if ((nullsjjkslobja[nullsjjkslobjai].style
																			.display != 'none') && (
																			nullsjjkslobja[nullsjjkslobjai]
																			.querySelector('a1').innerText == ""
																			)) {
																		nullarra.push(nullsjjkslobja[
																				nullsjjkslobjai]
																			.querySelector('a2').innerText)
																	}
																};
																nullarrahttpsjk = nullarra[Math.floor((Math
																	.random() * nullarra.length))];
																document.querySelector(
																	"ul#httpsvipul>li:nth-child(" +
																	nullarrahttpsjk + ")").click();
																sessionStorage.setItem('nullarrahttpsjk',
																	nullarrahttpsjk);
																if (localStorage.getItem("pcjkzdyj") == '1') {
																	$('ul#httpsvipul>li>span').css(
																		"backgroundImage", "");
														...
														try {
															if (sessionStorage.getItem("nullarrahttpsjk") ==
																null) {} else {
																arra.removeByValue(sessionStorage.getItem(
																	"nullarrahttpsjk"));
																sessionStorage.removeItem("nullarrahttpsjk");
															}
														} catch (err) {}
														arrahttpsjk = arra[Math.floor((Math.random() * arra
															.length))];
														document.querySelector("ul#httpsvipul>li:nth-child(" +
															arrahttpsjk + ")").click();
														if (localStorage.getItem("pcjkzdyj") == '1') {
														...
														if (localStorage.getItem("pcjkzdyj") == '1') {
															document.querySelector("ul#httpsvipul>li:nth-child(" +
																	arrahttpsjk + ")>span").style.backgroundImage =
																"url(" + jxbtupiana + ")";
